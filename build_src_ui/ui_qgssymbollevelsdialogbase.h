...
public:
    ...
    {
        QgsSymbolLevelsDialogBase->setWindowTitle(QApplication::translate("QgsSymbolLevelsDialogBase", "Symbol Levels", Q_NULLPTR));
        chkEnable->setText(QApplication::translate("QgsSymbolLevelsDialogBase", "Enable symbol levels", Q_NULLPTR));
        label->setText(QApplication::translate("QgsSymbolLevelsDialogBase", "Define the order in which the symbol layers are rendered. The numbers in the cells define in which rendering pass the layer will be drawn.", Q_NULLPTR));
    } // retranslateUi
