...
public:
    ...
    {
        label->setText(QApplication::translate("QgsPostgresProjectStorageDialog", "Connection", Q_NULLPTR));
        label_2->setText(QApplication::translate("QgsPostgresProjectStorageDialog", "Schema", Q_NULLPTR));
        label_3->setText(QApplication::translate("QgsPostgresProjectStorageDialog", "Project", Q_NULLPTR));
        mLblProjectsNotAllowed->setText(QApplication::translate("QgsPostgresProjectStorageDialog", "Storage of QGIS projects is not enabled for this database connection.", Q_NULLPTR));
