...
public:
    ...
    void setupUi(QWidget *QgsAuthConfigIdEdit)
    {
        ...
        QgsAuthConfigIdEdit->setWindowTitle(QStringLiteral("Form"));
...
#endif // QT_NO_TOOLTIP
        btnLock->setText(QApplication::translate("QgsAuthConfigIdEdit", "\342\200\246", Q_NULLPTR));
        Q_UNUSED(QgsAuthConfigIdEdit);
    } // retranslateUi
