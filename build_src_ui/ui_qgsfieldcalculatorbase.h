...
public:
    ...
    {
        QgsFieldCalculatorBase->setWindowTitle(QApplication::translate("QgsFieldCalculatorBase", "Field Calculator", Q_NULLPTR));
        mOnlyUpdateSelectedCheckBox->setText(QApplication::translate("QgsFieldCalculatorBase", "Only update selected features", Q_NULLPTR));
        mInfoIcon->setText(QString());
        mEditModeAutoTurnOnLabel->setText(QApplication::translate("QgsFieldCalculatorBase", "You are editing information on this layer but the layer is currently not in edit mode. If you click OK, edit mode will automatically be turned on.", Q_NULLPTR));
        mOnlyVirtualFieldsInfoLabel->setText(QApplication::translate("QgsFieldCalculatorBase", "This layer does not support adding new provider fields. You can only add virtual fields.", Q_NULLPTR));
        mUpdateExistingGroupBox->setTitle(QApplication::translate("QgsFieldCalculatorBase", "Update existing field", Q_NULLPTR));
        mNewFieldGroupBox->setTitle(QApplication::translate("QgsFieldCalculatorBase", "Create a new field", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mOutputFieldPrecisionSpinBox->setToolTip(QApplication::translate("QgsFieldCalculatorBase", "Maximum number of digits after the decimal place. For example 123.45 requires a field precision of 2.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFieldNameLabel->setText(QApplication::translate("QgsFieldCalculatorBase", "Output field name", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mOutputFieldWidthLabel->setToolTip(QApplication::translate("QgsFieldCalculatorBase", "Total length of field (including the number of digits after the decimal place for decimal fields).<br>For example 123.45 requires a decimal field length of 5, and 123456 requires an integer field length of 6.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mOutputFieldWidthLabel->setText(QApplication::translate("QgsFieldCalculatorBase", "Output field length", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mOutputFieldWidthSpinBox->setToolTip(QApplication::translate("QgsFieldCalculatorBase", "Total length of field (including the number of digits after the decimal place for decimal fields).<br>For example 123.45 requires a decimal field length of 5, and 123456 requires an integer field length of 6.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mOutputFieldTypeLabel->setText(QApplication::translate("QgsFieldCalculatorBase", "Output field type", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mOutputFieldPrecisionLabel->setToolTip(QApplication::translate("QgsFieldCalculatorBase", "Maximum number of digits after the decimal place. For example 123.45 requires a field precision of 2.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mOutputFieldPrecisionLabel->setText(QApplication::translate("QgsFieldCalculatorBase", "Precision", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mCreateVirtualFieldCheckbox->setToolTip(QApplication::translate("QgsFieldCalculatorBase", "<p>A virtual field will be recalculated every time it is used. Its definition will be saved in the project file. It will not be saved in the dataprovider and therefore its values not be available in other software.</p>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mCreateVirtualFieldCheckbox->setText(QApplication::translate("QgsFieldCalculatorBase", "Create virtual field", Q_NULLPTR));
    } // retranslateUi
