...
public:
    ...
    QgsPropertyOverrideButton *mShapePenStyleDDBtn;
    ...
    void setupUi(QWidget *QgsTextFormatWidgetBase)
    {
        if (QgsTextFormatWidgetBase->objectName().isEmpty())
            QgsTextFormatWidgetBase->setObjectName(QStringLiteral("QgsTextFormatWidgetBase"));
        ...
        frameLabelWith->setObjectName(QStringLiteral("frameLabelWith"));
        ...
        mLabelingFrame->setObjectName(QStringLiteral("mLabelingFrame"));
        ...
        mFontPreviewSplitter->setObjectName(QStringLiteral("mFontPreviewSplitter"));
        ...
        groupBox_mPreview->setObjectName(QStringLiteral("groupBox_mPreview"));
        QSizePolicy sizePolicy1(QSizePolicy::Preferred, QSizePolicy::MinimumExpanding);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(groupBox_mPreview->sizePolicy().hasHeightForWidth());
        groupBox_mPreview->setSizePolicy(sizePolicy1);
        ...
        scrollArea_mPreview->setObjectName(QStringLiteral("scrollArea_mPreview"));
        ...
        scrollAreaWidgetContents_mPreveiw->setObjectName(QStringLiteral("scrollAreaWidgetContents_mPreveiw"));
        ...
        scrollAreaWidgetContents_mPreveiw->setStyleSheet(QStringLiteral("background: rgb(255, 255, 255);"));
        ...
        lblFontPreview->setObjectName(QStringLiteral("lblFontPreview"));
        lblFontPreview->setEnabled(true);
        sizePolicy.setHeightForWidth(lblFontPreview->sizePolicy().hasHeightForWidth());
        lblFontPreview->setSizePolicy(sizePolicy);
        ...
        mPreviewTextEdit->setObjectName(QStringLiteral("mPreviewTextEdit"));
        ...
        mPreviewTextBtn->setObjectName(QStringLiteral("mPreviewTextBtn"));
        QIcon icon;
        ...
        mPreviewScaleComboBox->setObjectName(QStringLiteral("mPreviewScaleComboBox"));
        ...
        mPreviewBackgroundBtn->setObjectName(QStringLiteral("mPreviewBackgroundBtn"));
        ...
        mLabelingOptionsFrame->setObjectName(QStringLiteral("mLabelingOptionsFrame"));
        ...
        mOptionsTab->setObjectName(QStringLiteral("mOptionsTab"));
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/images/themes/default/propertyicons/labeltext.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mOptionsTab->addTab(textTab, icon1, QString());
        tab_2 = new QWidget();
        tab_2->setObjectName(QStringLiteral("tab_2"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/images/themes/default/propertyicons/labelformatting.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mOptionsTab->addTab(tab_2, icon2, QString());
        tab = new QWidget();
        tab->setObjectName(QStringLiteral("tab"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/images/themes/default/propertyicons/labelbuffer.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mOptionsTab->addTab(tab, icon3, QString());
        maskTab = new QWidget();
        maskTab->setObjectName(QStringLiteral("maskTab"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/images/themes/default/propertyicons/labelmask.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mOptionsTab->addTab(maskTab, icon4, QString());
        tab_3 = new QWidget();
        tab_3->setObjectName(QStringLiteral("tab_3"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/images/themes/default/propertyicons/labelbackground.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mOptionsTab->addTab(tab_3, icon5, QString());
        tab_4 = new QWidget();
        tab_4->setObjectName(QStringLiteral("tab_4"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/images/themes/default/propertyicons/labelshadow.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mOptionsTab->addTab(tab_4, icon6, QString());
        callouts = new QWidget();
        callouts->setObjectName(QStringLiteral("callouts"));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/images/themes/default/propertyicons/labelcallout.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mOptionsTab->addTab(callouts, icon7, QString());
        widget = new QWidget();
        widget->setObjectName(QStringLiteral("widget"));
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/images/themes/default/propertyicons/labelplacement.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mOptionsTab->addTab(widget, icon8, QString());
        tab_6 = new QWidget();
        tab_6->setObjectName(QStringLiteral("tab_6"));
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/images/themes/default/propertyicons/render.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mLabelingOptionsSplitter->setObjectName(QStringLiteral("mLabelingOptionsSplitter"));
        ...
        mLabelingOptionsListFrame->setObjectName(QStringLiteral("mLabelingOptionsListFrame"));
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/images/themes/default/propertyicons/labelmask.svg"), QSize(), QIcon::Normal, QIcon::On);
        ...
        mLabelingOptionsListWidget->setObjectName(QStringLiteral("mLabelingOptionsListWidget"));
        ...
        mLabelingOptionGroupsFrame->setObjectName(QStringLiteral("mLabelingOptionGroupsFrame"));
        ...
        mLabelStackedWidget->setObjectName(QStringLiteral("mLabelStackedWidget"));
        mLabelPage_Text = new QWidget();
        mLabelPage_Text->setObjectName(QStringLiteral("mLabelPage_Text"));
        ...
        mFontStyleGroupBox->setObjectName(QStringLiteral("mFontStyleGroupBox"));
        ...
        mFontOpacityDDBtn->setObjectName(QStringLiteral("mFontOpacityDDBtn"));
        ...
        mFontSizeDDBtn->setObjectName(QStringLiteral("mFontSizeDDBtn"));
        ...
        mFontFamilyFrame->setObjectName(QStringLiteral("mFontFamilyFrame"));
        ...
        mFontMissingLabel->setObjectName(QStringLiteral("mFontMissingLabel"));
        sizePolicy.setHeightForWidth(mFontMissingLabel->sizePolicy().hasHeightForWidth());
        mFontMissingLabel->setSizePolicy(sizePolicy);
        mFontMissingLabel->setStyleSheet(QLatin1String("color: #990000;\n"
"font-style: italic;"));
        ...
        mFontUnderlineDDBtn->setObjectName(QStringLiteral("mFontUnderlineDDBtn"));
        ...
        mFontStrikeoutDDBtn->setObjectName(QStringLiteral("mFontStrikeoutDDBtn"));
        ...
        mFontBoldDDBtn->setObjectName(QStringLiteral("mFontBoldDDBtn"));
        ...
        mFontTranspLabel->setObjectName(QStringLiteral("mFontTranspLabel"));
        ...
        mFontDDBtn->setObjectName(QStringLiteral("mFontDDBtn"));
        ...
        mHtmlFormattingCheckBox->setObjectName(QStringLiteral("mHtmlFormattingCheckBox"));
        ...
        mFontUnitsDDBtn->setObjectName(QStringLiteral("mFontUnitsDDBtn"));
        ...
        mFontLabel_2->setObjectName(QStringLiteral("mFontLabel_2"));
        ...
        mFontStyleLabel->setObjectName(QStringLiteral("mFontStyleLabel"));
        ...
        mFontSizeUnitWidget->setObjectName(QStringLiteral("mFontSizeUnitWidget"));
        ...
        mFontColorDDBtn->setObjectName(QStringLiteral("mFontColorDDBtn"));
        ...
        mFontSizeSpinBox->setMaximum(1e+9);
        ...
        mTextOpacityWidget->setObjectName(QStringLiteral("mTextOpacityWidget"));
        ...
        mFontItalicDDBtn->setObjectName(QStringLiteral("mFontItalicDDBtn"));
        ...
        mTextFormatsListWidget->setObjectName(QStringLiteral("mTextFormatsListWidget"));
        ...
        mLabelPage_Formatting->setObjectName(QStringLiteral("mLabelPage_Formatting"));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 374, 708));
        ...
        mFontCapitalsLabel->setObjectName(QStringLiteral("mFontCapitalsLabel"));
        ...
        mTextOrientationComboBox->setObjectName(QStringLiteral("mTextOrientationComboBox"));
        ...
        mToolButtonConfigureSubstitutes->setObjectName(QStringLiteral("mToolButtonConfigureSubstitutes"));
        ...
        mDirectSymbolsFrame->setObjectName(QStringLiteral("mDirectSymbolsFrame"));
        ...
        mDirectSymbDDBtn->setObjectName(QStringLiteral("mDirectSymbDDBtn"));

        gridLayout_33->addWidget(mDirectSymbDDBtn, 0, 1, 1, 1);

        mDirectSymbChkBx = new QCheckBox(mDirectSymbolsFrame);
        mDirectSymbChkBx->setObjectName(QStringLiteral("mDirectSymbChkBx"));
        ...
        mDirectSymbFrame->setObjectName(QStringLiteral("mDirectSymbFrame"));
        ...
        mDirectSymbRightFrame->setObjectName(QStringLiteral("mDirectSymbRightFrame"));
        ...
        mDirectSymbRightLineEdit->setObjectName(QStringLiteral("mDirectSymbRightLineEdit"));
        ...
        mDirectSymbRightToolBtn->setObjectName(QStringLiteral("mDirectSymbRightToolBtn"));
        ...
        mDirectSymbPlacementDDBtn->setObjectName(QStringLiteral("mDirectSymbPlacementDDBtn"));
        ...
        mDirectSymbLeftDDBtn->setObjectName(QStringLiteral("mDirectSymbLeftDDBtn"));

        gridLayout_30->addWidget(mDirectSymbLeftDDBtn, 0, 2, 1, 1);

        mDirectSymbLeftLabel = new QLabel(mDirectSymbFrame);
        mDirectSymbLeftLabel->setObjectName(QStringLiteral("mDirectSymbLeftLabel"));
        ...
        mDirectSymbRightLabel->setObjectName(QStringLiteral("mDirectSymbRightLabel"));

        gridLayout_30->addWidget(mDirectSymbRightLabel, 1, 0, 1, 1);

        mDirectSymbPlacementLabel = new QLabel(mDirectSymbFrame);
        mDirectSymbPlacementLabel->setObjectName(QStringLiteral("mDirectSymbPlacementLabel"));
        ...
        mDirectSymbLeftLineEdit->setObjectName(QStringLiteral("mDirectSymbLeftLineEdit"));
        ...
        mDirectSymbLeftToolBtn->setObjectName(QStringLiteral("mDirectSymbLeftToolBtn"));
        ...
        mDirectSymbRevDDBtn->setObjectName(QStringLiteral("mDirectSymbRevDDBtn"));

        gridLayout_30->addWidget(mDirectSymbRevDDBtn, 3, 2, 1, 1);

        mDirectSymbPlacementFrame = new QFrame(mDirectSymbFrame);
        mDirectSymbPlacementFrame->setObjectName(QStringLiteral("mDirectSymbPlacementFrame"));
        ...
        mDirectSymbRadioBtnLR->setObjectName(QStringLiteral("mDirectSymbRadioBtnLR"));
        ...
        mDirectSymbRadioBtnAbove->setObjectName(QStringLiteral("mDirectSymbRadioBtnAbove"));
        ...
        mDirectSymbRadioBtnBelow->setObjectName(QStringLiteral("mDirectSymbRadioBtnBelow"));
        ...
        mFontCaseDDBtn->setObjectName(QStringLiteral("mFontCaseDDBtn"));

        gridLayout_42->addWidget(mFontCaseDDBtn, 0, 3, 1, 1);

        labelTextOrientation = new QLabel(scrollAreaWidgetContents_6);
        labelTextOrientation->setObjectName(QStringLiteral("labelTextOrientation"));
        ...
        mFontLetterSpacingLabel_3->setObjectName(QStringLiteral("mFontLetterSpacingLabel_3"));
        ...
        mFontLetterSpacingSpinBox->setObjectName(QStringLiteral("mFontLetterSpacingSpinBox"));
        ...
        mFontLetterSpacingSpinBox->setMaximum(1e+9);
        ...
        mTextOrientationDDBtn->setObjectName(QStringLiteral("mTextOrientationDDBtn"));
        ...
        mCheckBoxSubstituteText->setObjectName(QStringLiteral("mCheckBoxSubstituteText"));
        ...
        mFontWordSpacingDDBtn->setObjectName(QStringLiteral("mFontWordSpacingDDBtn"));
        ...
        mFontLetterSpacingDDBtn->setObjectName(QStringLiteral("mFontLetterSpacingDDBtn"));
        ...
        comboBlendMode->setObjectName(QStringLiteral("comboBlendMode"));
        ...
        mFormatNumChkBx->setObjectName(QStringLiteral("mFormatNumChkBx"));
        ...
        mFormatNumDDBtn->setObjectName(QStringLiteral("mFormatNumDDBtn"));

        gridLayout_34->addWidget(mFormatNumDDBtn, 0, 1, 1, 1);

        mFormatNumFrame = new QFrame(scrollAreaWidgetContents_6);
        mFormatNumFrame->setObjectName(QStringLiteral("mFormatNumFrame"));
        ...
        mFormatNumDecimalsLabel->setObjectName(QStringLiteral("mFormatNumDecimalsLabel"));

        gridLayout_31->addWidget(mFormatNumDecimalsLabel, 0, 0, 1, 1);

        mFormatNumDecimalsSpnBx = new QgsSpinBox(mFormatNumFrame);
        mFormatNumDecimalsSpnBx->setObjectName(QStringLiteral("mFormatNumDecimalsSpnBx"));
        ...
        mFormatNumDecimalsDDBtn->setObjectName(QStringLiteral("mFormatNumDecimalsDDBtn"));

        gridLayout_31->addWidget(mFormatNumDecimalsDDBtn, 0, 2, 1, 1);

        mFormatNumPlusSignChkBx = new QCheckBox(mFormatNumFrame);
        mFormatNumPlusSignChkBx->setObjectName(QStringLiteral("mFormatNumPlusSignChkBx"));
        ...
        mFormatNumPlusSignDDBtn->setObjectName(QStringLiteral("mFormatNumPlusSignDDBtn"));
        ...
        mFontWordSpacingLabel_3->setObjectName(QStringLiteral("mFontWordSpacingLabel_3"));
        ...
        mFontWordSpacingSpinBox->setObjectName(QStringLiteral("mFontWordSpacingSpinBox"));
        ...
        mFontWordSpacingSpinBox->setMaximum(1e+9);
        ...
        mFontCapitalsComboBox->setObjectName(QStringLiteral("mFontCapitalsComboBox"));
        ...
        mMultiLinesFrame->setObjectName(QStringLiteral("mMultiLinesFrame"));
        ...
        mLabelWrapLinesTo->setObjectName(QStringLiteral("mLabelWrapLinesTo"));

        gridLayout_28->addWidget(mLabelWrapLinesTo, 1, 0, 1, 1);

        mFontMultiLineAlignComboBox = new QComboBox(mMultiLinesFrame);
        mFontMultiLineAlignComboBox->setObjectName(QStringLiteral("mFontMultiLineAlignComboBox"));
        ...
        wrapCharacterEdit->setObjectName(QStringLiteral("wrapCharacterEdit"));
        ...
        mFontMultiLineLabel->setObjectName(QStringLiteral("mFontMultiLineLabel"));
        ...
        mFontLineHeightSpinBox->setObjectName(QStringLiteral("mFontLineHeightSpinBox"));
        ...
        mFontLineHeightLabel->setObjectName(QStringLiteral("mFontLineHeightLabel"));
        ...
        mLabelWrapOnCharacter->setObjectName(QStringLiteral("mLabelWrapOnCharacter"));
        ...
        mAutoWrapLengthDDBtn->setObjectName(QStringLiteral("mAutoWrapLengthDDBtn"));
        ...
        mFontBlendModeDDBtn->setObjectName(QStringLiteral("mFontBlendModeDDBtn"));

        gridLayout_42->addWidget(mFontBlendModeDDBtn, 5, 3, 1, 1);

        mKerningCheckBox = new QCheckBox(scrollAreaWidgetContents_6);
        mKerningCheckBox->setObjectName(QStringLiteral("mKerningCheckBox"));
        ...
        mLabelPage_Buffer->setObjectName(QStringLiteral("mLabelPage_Buffer"));
        ...
        mBufferDrawDDBtn->setObjectName(QStringLiteral("mBufferDrawDDBtn"));
        ...
        mBufferFrame->setObjectName(QStringLiteral("mBufferFrame"));
        ...
        labelBufferBlend->setObjectName(QStringLiteral("labelBufferBlend"));

        gridLayout_12->addWidget(labelBufferBlend, 7, 0, 1, 1);

        btnBufferColor = new QgsColorButton(mBufferFrame);
        btnBufferColor->setObjectName(QStringLiteral("btnBufferColor"));
        ...
        mBufferEffectWidget->setObjectName(QStringLiteral("mBufferEffectWidget"));

        gridLayout_12->addWidget(mBufferEffectWidget, 8, 0, 1, 3);

        comboBufferBlendMode = new QgsBlendModeComboBox(mBufferFrame);
        comboBufferBlendMode->setObjectName(QStringLiteral("comboBufferBlendMode"));

        gridLayout_12->addWidget(comboBufferBlendMode, 7, 1, 1, 1);

        mBufferTranspFillChbx = new QCheckBox(mBufferFrame);
        mBufferTranspFillChbx->setObjectName(QStringLiteral("mBufferTranspFillChbx"));
        ...
        mBufferUnitWidget->setObjectName(QStringLiteral("mBufferUnitWidget"));
        ...
        mBufferJoinStyleDDBtn->setObjectName(QStringLiteral("mBufferJoinStyleDDBtn"));

        gridLayout_12->addWidget(mBufferJoinStyleDDBtn, 6, 2, 1, 1);

        mBufferJoinStyleComboBox = new QgsPenJoinStyleComboBox(mBufferFrame);
        mBufferJoinStyleComboBox->setObjectName(QStringLiteral("mBufferJoinStyleComboBox"));
        ...
        mBufferUnitsDDBtn->setObjectName(QStringLiteral("mBufferUnitsDDBtn"));
        ...
        spinBufferSize->setObjectName(QStringLiteral("spinBufferSize"));
        ...
        spinBufferSize->setMaximum(1e+9);
        ...
        mBufferOpacityWidget->setObjectName(QStringLiteral("mBufferOpacityWidget"));
        ...
        mBufferOpacityDDBtn->setObjectName(QStringLiteral("mBufferOpacityDDBtn"));

        gridLayout_12->addWidget(mBufferOpacityDDBtn, 4, 2, 1, 1);

        mBufferTranspLabel_2 = new QLabel(mBufferFrame);
        mBufferTranspLabel_2->setObjectName(QStringLiteral("mBufferTranspLabel_2"));
        ...
        mLabelPage_Mask->setObjectName(QStringLiteral("mLabelPage_Mask"));
        ...
        scrollArea_71->setObjectName(QStringLiteral("scrollArea_71"));
        scrollArea_71->setFrameShape(QFrame::NoFrame);
        scrollArea_71->setWidgetResizable(true);
        scrollAreaWidgetContents_31 = new QWidget();
        scrollAreaWidgetContents_31->setObjectName(QStringLiteral("scrollAreaWidgetContents_31"));
        ...
        gridLayout_361->setObjectName(QStringLiteral("gridLayout_361"));
        ...
        mEnableMaskDDBtn->setObjectName(QStringLiteral("mEnableMaskDDBtn"));

        gridLayout_361->addWidget(mEnableMaskDDBtn, 1, 1, 1, 1);

        mEnableMaskChkBx = new QCheckBox(scrollAreaWidgetContents_31);
        mEnableMaskChkBx->setObjectName(QStringLiteral("mEnableMaskChkBx"));
        ...
        mMaskFrame->setObjectName(QStringLiteral("mMaskFrame"));
        ...
        mMaskJoinStyleComboBox->setObjectName(QStringLiteral("mMaskJoinStyleComboBox"));
        ...
        mMaskBufferSizeSpinBox->setMaximum(1e+9);
        mMaskBufferSizeSpinBox->setSingleStep(0.1);
        ...
        mMaskBufferSizeDDBtn->setObjectName(QStringLiteral("mMaskBufferSizeDDBtn"));

        gridLayout_121->addWidget(mMaskBufferSizeDDBtn, 0, 2, 1, 1);

        mMaskOpacityWidget = new QgsOpacityWidget(mMaskFrame);
        mMaskOpacityWidget->setObjectName(QStringLiteral("mMaskOpacityWidget"));
        ...
        mMaskTranspLabel_2->setObjectName(QStringLiteral("mMaskTranspLabel_2"));
        ...
        mLabelPage_Background->setObjectName(QStringLiteral("mLabelPage_Background"));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 444, 786));
        ...
        mShapeDrawChkBx->setObjectName(QStringLiteral("mShapeDrawChkBx"));
        ...
        mShapeDrawDDBtn->setObjectName(QStringLiteral("mShapeDrawDDBtn"));

        gridLayout_37->addWidget(mShapeDrawDDBtn, 1, 1, 1, 1);

        mShapeFrame = new QFrame(scrollAreaWidgetContents_2);
        mShapeFrame->setObjectName(QStringLiteral("mShapeFrame"));
        ...
        mShapeSizeXDDBtn->setObjectName(QStringLiteral("mShapeSizeXDDBtn"));

        gridLayout_29->addWidget(mShapeSizeXDDBtn, 4, 3, 1, 1);

        mShapeFillColorLabel = new QLabel(mShapeFrame);
        mShapeFillColorLabel->setObjectName(QStringLiteral("mShapeFillColorLabel"));
        ...
        mShapeSizeYDDBtn->setObjectName(QStringLiteral("mShapeSizeYDDBtn"));

        gridLayout_29->addWidget(mShapeSizeYDDBtn, 5, 3, 1, 1);

        mShapeFillColorBtn = new QgsColorButton(mShapeFrame);
        mShapeFillColorBtn->setObjectName(QStringLiteral("mShapeFillColorBtn"));
        ...
        mShapeSizeCmbBx->setObjectName(QStringLiteral("mShapeSizeCmbBx"));
        ...
        mShapeRotationTypeDDBtn->setObjectName(QStringLiteral("mShapeRotationTypeDDBtn"));
        ...
        mShapeStrokeWidthUnitWidget->setObjectName(QStringLiteral("mShapeStrokeWidthUnitWidget"));
        ...
        mShapeSVGUnitsLabel->setObjectName(QStringLiteral("mShapeSVGUnitsLabel"));
        ...
        mShapeBlendCmbBx->setObjectName(QStringLiteral("mShapeBlendCmbBx"));
        ...
        mShapeRotationDblSpnBx->setObjectName(QStringLiteral("mShapeRotationDblSpnBx"));
        ...
        mShapeRotationDblSpnBx->setMinimum(-360);
        mShapeRotationDblSpnBx->setMaximum(360);

        gridLayout_29->addWidget(mShapeRotationDblSpnBx, 9, 1, 1, 1);

        mShapeSVGPathFrame = new QFrame(mShapeFrame);
        mShapeSVGPathFrame->setObjectName(QStringLiteral("mShapeSVGPathFrame"));
        ...
        mShapeFillColorDDBtn->setObjectName(QStringLiteral("mShapeFillColorDDBtn"));
        ...
        mShapeRadiusXDbSpnBx->setObjectName(QStringLiteral("mShapeRadiusXDbSpnBx"));
        ...
        mShapeRadiusXDbSpnBx->setMaximum(1e+9);
        ...
        mShapeRadiusYDbSpnBx->setObjectName(QStringLiteral("mShapeRadiusYDbSpnBx"));
        ...
        mShapeRadiusYDbSpnBx->setMaximum(1e+9);
        ...
        mShapePenStyleLabel->setObjectName(QStringLiteral("mShapePenStyleLabel"));
        ...
        mShapeStrokeUnitsDDBtn->setObjectName(QStringLiteral("mShapeStrokeUnitsDDBtn"));

        gridLayout_29->addWidget(mShapeStrokeUnitsDDBtn, 20, 3, 1, 1);

        mShapeRadiusUnitWidget = new QgsUnitSelectionWidget(mShapeFrame);
        mShapeRadiusUnitWidget->setObjectName(QStringLiteral("mShapeRadiusUnitWidget"));
        ...
        mShapeRadiusUnitsDDBtn->setObjectName(QStringLiteral("mShapeRadiusUnitsDDBtn"));

        gridLayout_29->addWidget(mShapeRadiusUnitsDDBtn, 13, 3, 1, 1);

        mShapeRotationFrame = new QFrame(mShapeFrame);
        mShapeRotationFrame->setObjectName(QStringLiteral("mShapeRotationFrame"));
        ...
        mShapeRotationDDBtn->setObjectName(QStringLiteral("mShapeRotationDDBtn"));
        ...
        mShapeOffsetXSpnBx->setObjectName(QStringLiteral("mShapeOffsetXSpnBx"));
        ...
        mShapeOffsetXSpnBx->setMinimum(-1e+7);
        mShapeOffsetXSpnBx->setMaximum(1e+7);
        ...
        mShapeOffsetYSpnBx->setObjectName(QStringLiteral("mShapeOffsetYSpnBx"));
        ...
        mShapeOffsetYSpnBx->setMinimum(-1e+7);
        mShapeOffsetYSpnBx->setMaximum(1e+7);
        ...
        mShapeSizeXLabel->setObjectName(QStringLiteral("mShapeSizeXLabel"));

        gridLayout_29->addWidget(mShapeSizeXLabel, 4, 0, 1, 1);

        mShapeSizeXSpnBx = new QgsDoubleSpinBox(mShapeFrame);
        mShapeSizeXSpnBx->setObjectName(QStringLiteral("mShapeSizeXSpnBx"));
        mShapeSizeXSpnBx->setDecimals(4);
        mShapeSizeXSpnBx->setMinimum(-1e+7);
        mShapeSizeXSpnBx->setMaximum(1e+7);
        ...
        mShapeStrokeColorBtn->setObjectName(QStringLiteral("mShapeStrokeColorBtn"));
        ...
        mShapeOffsetUnitsDDBtn->setObjectName(QStringLiteral("mShapeOffsetUnitsDDBtn"));

        gridLayout_29->addWidget(mShapeOffsetUnitsDDBtn, 11, 3, 1, 1);

        mShapeRotationCmbBx = new QComboBox(mShapeFrame);
        mShapeRotationCmbBx->setObjectName(QStringLiteral("mShapeRotationCmbBx"));

        gridLayout_29->addWidget(mShapeRotationCmbBx, 8, 1, 1, 1);

        mShapeStrokeColorLabel = new QLabel(mShapeFrame);
        mShapeStrokeColorLabel->setObjectName(QStringLiteral("mShapeStrokeColorLabel"));
        ...
        mShapeSizeUnitsDDBtn->setObjectName(QStringLiteral("mShapeSizeUnitsDDBtn"));

        gridLayout_29->addWidget(mShapeSizeUnitsDDBtn, 6, 3, 1, 1);

        mShapeBlendModeDDBtn = new QgsPropertyOverrideButton(mShapeFrame);
        mShapeBlendModeDDBtn->setObjectName(QStringLiteral("mShapeBlendModeDDBtn"));
        ...
        mShapeTranspLabel->setObjectName(QStringLiteral("mShapeTranspLabel"));
        ...
        mBackgroundEffectWidget->setObjectName(QStringLiteral("mBackgroundEffectWidget"));
        ...
        mShapeSizeYLabel->setObjectName(QStringLiteral("mShapeSizeYLabel"));

        gridLayout_29->addWidget(mShapeSizeYLabel, 5, 0, 1, 1);

        mBackgroundOpacityWidget = new QgsOpacityWidget(mShapeFrame);
        mBackgroundOpacityWidget->setObjectName(QStringLiteral("mBackgroundOpacityWidget"));
        ...
        mShapeStrokeWidthSpnBx->setObjectName(QStringLiteral("mShapeStrokeWidthSpnBx"));
        mShapeStrokeWidthSpnBx->setDecimals(4);
        mShapeStrokeWidthSpnBx->setMinimum(0);
        mShapeStrokeWidthSpnBx->setMaximum(1e+7);
        mShapeStrokeWidthSpnBx->setSingleStep(0.1);
        ...
        mShapeTypeDDBtn->setObjectName(QStringLiteral("mShapeTypeDDBtn"));

        gridLayout_29->addWidget(mShapeTypeDDBtn, 0, 3, 1, 1);

        mShapeSizeYSpnBx = new QgsDoubleSpinBox(mShapeFrame);
        mShapeSizeYSpnBx->setObjectName(QStringLiteral("mShapeSizeYSpnBx"));
        mShapeSizeYSpnBx->setDecimals(4);
        mShapeSizeYSpnBx->setMinimum(-1e+7);
        mShapeSizeYSpnBx->setMaximum(1e+7);
        ...
        mShapeRadiusDDBtn->setObjectName(QStringLiteral("mShapeRadiusDDBtn"));

        gridLayout_29->addWidget(mShapeRadiusDDBtn, 12, 3, 1, 1);

        mShapeOffsetUnitWidget = new QgsUnitSelectionWidget(mShapeFrame);
        mShapeOffsetUnitWidget->setObjectName(QStringLiteral("mShapeOffsetUnitWidget"));
        mShapeOffsetUnitWidget->setFocusPolicy(Qt::StrongFocus);

        gridLayout_29->addWidget(mShapeOffsetUnitWidget, 11, 1, 1, 1);

        mShapePenStyleDDBtn = new QgsPropertyOverrideButton(mShapeFrame);
        mShapePenStyleDDBtn->setObjectName(QStringLiteral("mShapePenStyleDDBtn"));

        gridLayout_29->addWidget(mShapePenStyleDDBtn, 21, 3, 1, 1);

        mBackgroundSymbolButton = new QgsSymbolButton(mShapeFrame);
        mBackgroundSymbolButton->setObjectName(QStringLiteral("mBackgroundSymbolButton"));
        sizePolicy4.setHeightForWidth(mBackgroundSymbolButton->sizePolicy().hasHeightForWidth());
        mBackgroundSymbolButton->setSizePolicy(sizePolicy4);

        gridLayout_29->addWidget(mBackgroundSymbolButton, 2, 1, 1, 2);
        ...
        mLabelPage_Shadow->setObjectName(QStringLiteral("mLabelPage_Shadow"));
        ...
        mShadowDrawChkBx->setObjectName(QStringLiteral("mShadowDrawChkBx"));
        ...
        mShadowDrawDDBtn->setObjectName(QStringLiteral("mShadowDrawDDBtn"));
        ...
        mShadowRadiusDblSpnBx->setObjectName(QStringLiteral("mShadowRadiusDblSpnBx"));
        mShadowRadiusDblSpnBx->setDecimals(6);
        mShadowRadiusDblSpnBx->setMaximum(1e+9);
        ...
        mShadowRadiusAlphaChkBx->setObjectName(QStringLiteral("mShadowRadiusAlphaChkBx"));
        ...
        mShadowOffsetGlobalChkBx->setObjectName(QStringLiteral("mShadowOffsetGlobalChkBx"));
        ...
        mShadowUnderCmbBx->setObjectName(QStringLiteral("mShadowUnderCmbBx"));
        ...
        mShadowScaleSpnBx->setObjectName(QStringLiteral("mShadowScaleSpnBx"));
        ...
        mShadowRadiusUnitWidget->setObjectName(QStringLiteral("mShadowRadiusUnitWidget"));
        ...
        mShadowOpacityWidget->setObjectName(QStringLiteral("mShadowOpacityWidget"));
        ...
        mLabelPage_Callouts->setObjectName(QStringLiteral("mLabelPage_Callouts"));
        ...
        mCalloutsDrawCheckBox->setObjectName(QStringLiteral("mCalloutsDrawCheckBox"));
        ...
        mCalloutDrawDDBtn->setObjectName(QStringLiteral("mCalloutDrawDDBtn"));

        gridLayout_43->addWidget(mCalloutDrawDDBtn, 1, 1, 1, 1);

        mCalloutFrame = new QFrame(scrollAreaWidgetContents_7);
        mCalloutFrame->setObjectName(QStringLiteral("mCalloutFrame"));
        ...
        mCalloutStyleComboBox->setObjectName(QStringLiteral("mCalloutStyleComboBox"));

        gridLayout_45->addWidget(mCalloutStyleComboBox, 0, 1, 1, 2);

        mCalloutStackedWidget = new QStackedWidget(mCalloutFrame);
        mCalloutStackedWidget->setObjectName(QStringLiteral("mCalloutStackedWidget"));
        ...
        mLabelPage_Placement->setObjectName(QStringLiteral("mLabelPage_Placement"));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 472, 1686));
        ...
        mPlacementPolygonFrame->setObjectName(QStringLiteral("mPlacementPolygonFrame"));
        ...
        mCheckAllowLabelsOutsidePolygons->setObjectName(QStringLiteral("mCheckAllowLabelsOutsidePolygons"));
        ...
        mAllowOutsidePolygonsDDBtn->setObjectName(QStringLiteral("mAllowOutsidePolygonsDDBtn"));
        ...
        mPlacementCentroidFrame->setObjectName(QStringLiteral("mPlacementCentroidFrame"));
        ...
        mCentroidRadioVisible->setObjectName(QStringLiteral("mCentroidRadioVisible"));
        ...
        mCentroidDDBtn->setObjectName(QStringLiteral("mCentroidDDBtn"));

        gridLayout_25->addWidget(mCentroidDDBtn, 1, 3, 1, 1);

        mCentroidRadioWhole = new QRadioButton(mPlacementCentroidFrame);
        mCentroidRadioWhole->setObjectName(QStringLiteral("mCentroidRadioWhole"));
        ...
        mCentroidInsideCheckBox->setObjectName(QStringLiteral("mCentroidInsideCheckBox"));

        gridLayout_25->addWidget(mCentroidInsideCheckBox, 2, 1, 1, 3);

        mCentroidLabel = new QLabel(mPlacementCentroidFrame);
        mCentroidLabel->setObjectName(QStringLiteral("mCentroidLabel"));
        ...
        mPlacementModeComboBox->setObjectName(QStringLiteral("mPlacementModeComboBox"));
        ...
        mPlacementQuadrantFrame->setObjectName(QStringLiteral("mPlacementQuadrantFrame"));
        ...
        mPointQuadOffsetDDBtn->setObjectName(QStringLiteral("mPointQuadOffsetDDBtn"));

        gridLayout_19->addWidget(mPointQuadOffsetDDBtn, 0, 2, 1, 1);

        mPlacementFixedQuadrantFrame = new QFrame(mPlacementQuadrantFrame);
        mPlacementFixedQuadrantFrame->setObjectName(QStringLiteral("mPlacementFixedQuadrantFrame"));
        ...
        mPointOffsetOver->setObjectName(QStringLiteral("mPointOffsetOver"));
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/images/themes/default/mIconLabelQuadrantCenter.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mPointOffsetAboveRight->setObjectName(QStringLiteral("mPointOffsetAboveRight"));
        QIcon icon12;
        icon12.addFile(QStringLiteral(":/images/themes/default/mIconLabelQuadrantOffset.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mPointOffsetBelowLeft->setObjectName(QStringLiteral("mPointOffsetBelowLeft"));
        ...
        mPointOffsetLeft->setObjectName(QStringLiteral("mPointOffsetLeft"));
        ...
        mPointOffsetAboveLeft->setObjectName(QStringLiteral("mPointOffsetAboveLeft"));
        ...
        mPointOffsetRight->setObjectName(QStringLiteral("mPointOffsetRight"));
        ...
        mPointOffsetBelow->setObjectName(QStringLiteral("mPointOffsetBelow"));
        ...
        mPointOffsetBelowRight->setObjectName(QStringLiteral("mPointOffsetBelowRight"));
        ...
        mPointOffsetAbove->setObjectName(QStringLiteral("mPointOffsetAbove"));
        ...
        mPlacementLineFrame->setObjectName(QStringLiteral("mPlacementLineFrame"));
        ...
        mLinePlacementFlagsDDBtn->setObjectName(QStringLiteral("mLinePlacementFlagsDDBtn"));
        ...
        mPlacementOffsetTypeFrame->setObjectName(QStringLiteral("mPlacementOffsetTypeFrame"));
        ...
        mOffsetTypeComboBox->setObjectName(QStringLiteral("mOffsetTypeComboBox"));
        ...
        mPlacementOffsetFrame->setObjectName(QStringLiteral("mPlacementOffsetFrame"));
        ...
        mPointOffsetYSpinBox->setObjectName(QStringLiteral("mPointOffsetYSpinBox"));
        ...
        mPointOffsetYSpinBox->setMinimum(-1e+7);
        mPointOffsetYSpinBox->setMaximum(1e+7);
        ...
        mPointOffsetDDBtn->setObjectName(QStringLiteral("mPointOffsetDDBtn"));
        ...
        mPointOffsetUnitsDDBtn->setObjectName(QStringLiteral("mPointOffsetUnitsDDBtn"));

        gridLayout_15->addWidget(mPointOffsetUnitsDDBtn, 1, 3, 1, 1);

        mPointOffsetXSpinBox = new QgsDoubleSpinBox(mPlacementOffsetFrame);
        mPointOffsetXSpinBox->setObjectName(QStringLiteral("mPointOffsetXSpinBox"));
        ...
        mPointOffsetXSpinBox->setMinimum(-1e+7);
        mPointOffsetXSpinBox->setMaximum(1e+7);
        ...
        mPointOffsetUnitWidget->setObjectName(QStringLiteral("mPointOffsetUnitWidget"));
        ...
        mPlacementDistanceFrame->setObjectName(QStringLiteral("mPlacementDistanceFrame"));
        ...
        mLineDistanceSpnBx->setObjectName(QStringLiteral("mLineDistanceSpnBx"));
        mLineDistanceSpnBx->setDecimals(4);
        mLineDistanceSpnBx->setMinimum(-1e+9);
        mLineDistanceSpnBx->setMaximum(1e+9);
        ...
        mLineDistanceDDBtn->setObjectName(QStringLiteral("mLineDistanceDDBtn"));
        ...
        mLineDistanceUnitDDBtn->setObjectName(QStringLiteral("mLineDistanceUnitDDBtn"));
        ...
        mLineDistanceUnitWidget->setObjectName(QStringLiteral("mLineDistanceUnitWidget"));
        ...
        mPlacementCartographicFrame->setObjectName(QStringLiteral("mPlacementCartographicFrame"));
        ...
        mPointPositionOrderDDBtn->setObjectName(QStringLiteral("mPointPositionOrderDDBtn"));
        ...
        mPlacementFixedQuadrantFrame_2->setObjectName(QStringLiteral("mPlacementFixedQuadrantFrame_2"));
        ...
        mPlacementModeDescriptionLabel->setObjectName(QStringLiteral("mPlacementModeDescriptionLabel"));
        ...
        mPlacementRotationFrame->setObjectName(QStringLiteral("mPlacementRotationFrame"));
        ...
        mPointAngleSpinBox->setObjectName(QStringLiteral("mPointAngleSpinBox"));
        ...
        mPlacementRepeatGroupBox->setObjectName(QStringLiteral("mPlacementRepeatGroupBox"));
        ...
        mRepeatDistanceSpinBox->setObjectName(QStringLiteral("mRepeatDistanceSpinBox"));
        ...
        mRepeatDistanceSpinBox->setMaximum(1e+9);
        ...
        mRepeatDistanceDDBtn->setObjectName(QStringLiteral("mRepeatDistanceDDBtn"));
        ...
        mRepeatDistanceUnitWidget->setObjectName(QStringLiteral("mRepeatDistanceUnitWidget"));
        ...
        mRepeatDistanceUnitDDBtn->setObjectName(QStringLiteral("mRepeatDistanceUnitDDBtn"));
        ...
        mPlacementOverrunGroupBox->setObjectName(QStringLiteral("mPlacementOverrunGroupBox"));
        ...
        mOverrunDistanceUnitWidget->setObjectName(QStringLiteral("mOverrunDistanceUnitWidget"));
        ...
        mOverrunDistanceSpinBox->setObjectName(QStringLiteral("mOverrunDistanceSpinBox"));
        ...
        mOverrunDistanceSpinBox->setMaximum(1e+9);
        ...
        mOverrunDistanceDDBtn->setObjectName(QStringLiteral("mOverrunDistanceDDBtn"));
        ...
        mLineAnchorGroupBox->setObjectName(QStringLiteral("mLineAnchorGroupBox"));
        ...
        mLblPlacementAlongLine->setObjectName(QStringLiteral("mLblPlacementAlongLine"));
        ...
        mLineAnchorSettingsButton->setObjectName(QStringLiteral("mLineAnchorSettingsButton"));
        ...
        mPlacementMaxCharAngleFrame->setObjectName(QStringLiteral("mPlacementMaxCharAngleFrame"));
        ...
        mMaxCharAngleInDSpinBox->setObjectName(QStringLiteral("mMaxCharAngleInDSpinBox"));
        ...
        mMaxCharAngleOutLabel->setObjectName(QStringLiteral("mMaxCharAngleOutLabel"));
        ...
        mMaxCharAngleInLabel->setObjectName(QStringLiteral("mMaxCharAngleInLabel"));
        ...
        mMaxCharAngleDDBtn->setObjectName(QStringLiteral("mMaxCharAngleDDBtn"));
        ...
        mMaxCharAngleLabel->setObjectName(QStringLiteral("mMaxCharAngleLabel"));
        sizePolicy.setHeightForWidth(mMaxCharAngleLabel->sizePolicy().hasHeightForWidth());
        mMaxCharAngleLabel->setSizePolicy(sizePolicy);
        ...
        mMaxCharAngleOutDSpinBox->setObjectName(QStringLiteral("mMaxCharAngleOutDSpinBox"));
        ...
        mGeometryGeneratorGroupBox->setObjectName(QStringLiteral("mGeometryGeneratorGroupBox"));
        ...
        mGeometryGenerator->setObjectName(QStringLiteral("mGeometryGenerator"));
        ...
        mGeometryGeneratorExpressionButton->setObjectName(QStringLiteral("mGeometryGeneratorExpressionButton"));
        ...
        mGeometryGeneratorWarningLabel->setObjectName(QStringLiteral("mGeometryGeneratorWarningLabel"));
        ...
        mGeometryGeneratorType->setObjectName(QStringLiteral("mGeometryGeneratorType"));
        ...
        mPlacementDDGroupBox->setObjectName(QStringLiteral("mPlacementDDGroupBox"));
        mPlacementDDGroupBox->setFlat(false);
        mPlacementDDGroupBox->setProperty("syncGroup", QVariant(QStringLiteral("labelplacementgroup")));
        ...
        mCoordAlignmentHLabel->setObjectName(QStringLiteral("mCoordAlignmentHLabel"));
        ...
        mCoordAlignmentHDDBtn->setObjectName(QStringLiteral("mCoordAlignmentHDDBtn"));

        horizontalLayout_27->addWidget(mCoordAlignmentHDDBtn);

        mCoordAlignmentVLabel = new QLabel(mCoordAlignmentFrame);
        mCoordAlignmentVLabel->setObjectName(QStringLiteral("mCoordAlignmentVLabel"));
        ...
        mCoordAlignmentVDDBtn->setObjectName(QStringLiteral("mCoordAlignmentVDDBtn"));
        ...
        mCoordRotationDDBtn->setObjectName(QStringLiteral("mCoordRotationDDBtn"));

        horizontalLayout_25->addWidget(mCoordRotationDDBtn);

        chkPreserveRotation = new QCheckBox(mPlacementDDGroupBox);
        chkPreserveRotation->setObjectName(QStringLiteral("chkPreserveRotation"));
        chkPreserveRotation->setStyleSheet(QStringLiteral("margin-left: 12px; margin-top: 3px;"));
        ...
        mPriorityGrpBx->setObjectName(QStringLiteral("mPriorityGrpBx"));
        mPriorityGrpBx->setProperty("syncGroup", QVariant(QStringLiteral("labelplacementgroup")));
        ...
        mObstaclesGroupBox->setObjectName(QStringLiteral("mObstaclesGroupBox"));
        ...
        mLblNoObstacle->setObjectName(QStringLiteral("mLblNoObstacle"));
        ...
        mObstacleSettingsButton->setObjectName(QStringLiteral("mObstacleSettingsButton"));
        ...
        mLabelPage_Rendering->setObjectName(QStringLiteral("mLabelPage_Rendering"));
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, -304, 471, 708));
        ...
        mRenderingLabelGrpBx->setObjectName(QStringLiteral("mRenderingLabelGrpBx"));
        mRenderingLabelGrpBx->setProperty("syncGroup", QVariant(QStringLiteral("labelrenderinggroup")));
        ...
        mScaleBasedVisibilityChkBx->setObjectName(QStringLiteral("mScaleBasedVisibilityChkBx"));
        ...
        mScaleBasedVisibilityDDBtn->setObjectName(QStringLiteral("mScaleBasedVisibilityDDBtn"));
        ...
        mScaleBasedVisibilityFrame->setObjectName(QStringLiteral("mScaleBasedVisibilityFrame"));
        ...
        mScaleBasedVisibilityMaxDDBtn->setObjectName(QStringLiteral("mScaleBasedVisibilityMaxDDBtn"));
        ...
        mScaleBasedVisibilityMinDDBtn->setObjectName(QStringLiteral("mScaleBasedVisibilityMinDDBtn"));

        gridLayout_2->addWidget(mScaleBasedVisibilityMinDDBtn, 0, 2, 1, 1);

        mLabelMinScale = new QLabel(mScaleBasedVisibilityFrame);
        mLabelMinScale->setObjectName(QStringLiteral("mLabelMinScale"));
        ...
        mLabelMaxScale->setObjectName(QStringLiteral("mLabelMaxScale"));
        ...
        mFontLimitPixelFrame->setObjectName(QStringLiteral("mFontLimitPixelFrame"));
        ...
        mFontMinPixelSpinBox->setObjectName(QStringLiteral("mFontMinPixelSpinBox"));
        ...
        mFontMinPixelDDBtn->setObjectName(QStringLiteral("mFontMinPixelDDBtn"));

        gridLayout_32->addWidget(mFontMinPixelDDBtn, 0, 1, 1, 1);

        mFontMaxPixelSpinBox = new QgsSpinBox(mFontLimitPixelFrame);
        mFontMaxPixelSpinBox->setObjectName(QStringLiteral("mFontMaxPixelSpinBox"));
        ...
        mFontMaxPixelDDBtn->setObjectName(QStringLiteral("mFontMaxPixelDDBtn"));
        ...
        mFontLimitPixelDDBtn->setObjectName(QStringLiteral("mFontLimitPixelDDBtn"));

        gridLayout_16->addWidget(mFontLimitPixelDDBtn, 0, 2, 1, 1);

        mFontLimitPixelChkBox = new QCheckBox(mRenderingLabelGrpBx);
        mFontLimitPixelChkBox->setObjectName(QStringLiteral("mFontLimitPixelChkBox"));
        ...
        mZIndexDDBtn->setObjectName(QStringLiteral("mZIndexDDBtn"));
        ...
        mPalShowAllLabelsForLayerChkBx->setObjectName(QStringLiteral("mPalShowAllLabelsForLayerChkBx"));

        verticalLayout_16->addWidget(mPalShowAllLabelsForLayerChkBx);

        mLabelRenderingDDFrame = new QFrame(mRenderingLabelGrpBx);
        mLabelRenderingDDFrame->setObjectName(QStringLiteral("mLabelRenderingDDFrame"));
        ...
        mShowLabelDDBtn->setObjectName(QStringLiteral("mShowLabelDDBtn"));
        ...
        mShowLabelLabel->setObjectName(QStringLiteral("mShowLabelLabel"));
        ...
        mUpsidedownFrame->setObjectName(QStringLiteral("mUpsidedownFrame"));
        ...
        mUpsidedownRadioAll->setObjectName(QStringLiteral("mUpsidedownRadioAll"));

        gridLayout->addWidget(mUpsidedownRadioAll, 1, 3, 1, 1);

        mUpsidedownRadioOff = new QRadioButton(mUpsidedownFrame);
        mUpsidedownRadioOff->setObjectName(QStringLiteral("mUpsidedownRadioOff"));
        ...
        mUpsidedownRadioDefined->setObjectName(QStringLiteral("mUpsidedownRadioDefined"));
        ...
        mUpsidedownLabel->setObjectName(QStringLiteral("mUpsidedownLabel"));
        ...
        mRenderingFeaturesGrpBx->setObjectName(QStringLiteral("mRenderingFeaturesGrpBx"));
        mRenderingFeaturesGrpBx->setProperty("syncGroup", QVariant(QStringLiteral("labelrenderinggroup")));
        ...
        chkLabelPerFeaturePart->setObjectName(QStringLiteral("chkLabelPerFeaturePart"));
        ...
        mFitInsidePolygonCheckBox->setObjectName(QStringLiteral("mFitInsidePolygonCheckBox"));
        ...
        mMinSizeFrame->setObjectName(QStringLiteral("mMinSizeFrame"));
        ...
        mMinSizeSpinBox->setObjectName(QStringLiteral("mMinSizeSpinBox"));
        ...
        mLimitLabelFrame->setObjectName(QStringLiteral("mLimitLabelFrame"));
        ...
        mLimitLabelSpinBox->setObjectName(QStringLiteral("mLimitLabelSpinBox"));
        ...
        mLimitLabelChkBox->setObjectName(QStringLiteral("mLimitLabelChkBox"));
        ...
        gridLayout_8->addWidget(mLabelingFrame, 3, 0, 1, 1);

#ifndef QT_NO_SHORTCUT
        mLblNoObstacle1->setBuddy(mChkNoObstacle);
#endif // QT_NO_SHORTCUT
        QWidget::setTabOrder(mFieldExpressionWidget, mPreviewTextEdit);
        ...
        QWidget::setTabOrder(scrollArea_7, mEnableMaskChkBx);
        QWidget::setTabOrder(mEnableMaskChkBx, mEnableMaskDDBtn);
        QWidget::setTabOrder(mEnableMaskDDBtn, spinBufferSize);
        ...
        QWidget::setTabOrder(mShapeSVGPathDDBtn, mBackgroundSymbolButton);
        QWidget::setTabOrder(mBackgroundSymbolButton, mShapeSizeCmbBx);
        ...
        QWidget::setTabOrder(mShapeStrokeUnitsDDBtn, mShapePenStyleCmbBx);
        ...
        QWidget::setTabOrder(mAllowOutsidePolygonsDDBtn, mLinePlacementFlagsDDBtn);
        QWidget::setTabOrder(mLinePlacementFlagsDDBtn, mCentroidRadioVisible);
        ...
        QWidget::setTabOrder(mPointAngleSpinBox, mMaxCharAngleInDSpinBox);
        ...
        QWidget::setTabOrder(mFitInsidePolygonCheckBox, scrollArea_mPreview);
        QWidget::setTabOrder(scrollArea_mPreview, mGeometryGeneratorGroupBox);
        ...
        QWidget::setTabOrder(mGeometryGeneratorType, mFontWordSpacingSpinBox);
        QWidget::setTabOrder(mFontWordSpacingSpinBox, mFontCaseDDBtn);
        QWidget::setTabOrder(mFontCaseDDBtn, mFontLetterSpacingSpinBox);
        QWidget::setTabOrder(mFontLetterSpacingSpinBox, comboBlendMode);
        QWidget::setTabOrder(comboBlendMode, mToolButtonConfigureSubstitutes);
        QWidget::setTabOrder(mToolButtonConfigureSubstitutes, mFontBlendModeDDBtn);
        QWidget::setTabOrder(mFontBlendModeDDBtn, mFontCapitalsComboBox);
        QWidget::setTabOrder(mFontCapitalsComboBox, mFontLetterSpacingDDBtn);
        QWidget::setTabOrder(mFontLetterSpacingDDBtn, mCheckBoxSubstituteText);
        QWidget::setTabOrder(mCheckBoxSubstituteText, mFontWordSpacingDDBtn);
        QWidget::setTabOrder(mFontWordSpacingDDBtn, mTextOrientationComboBox);
        QWidget::setTabOrder(mTextOrientationComboBox, mTextOrientationDDBtn);
        QWidget::setTabOrder(mTextOrientationDDBtn, mKerningCheckBox);
        QWidget::setTabOrder(mKerningCheckBox, mBufferDrawDDBtn);
        QWidget::setTabOrder(mBufferDrawDDBtn, mBufferDrawChkBx);
        QWidget::setTabOrder(mBufferDrawChkBx, scrollArea_71);
        QWidget::setTabOrder(scrollArea_71, mMaskJoinStyleComboBox);
        QWidget::setTabOrder(mMaskJoinStyleComboBox, mMaskOpacityDDBtn);
        QWidget::setTabOrder(mMaskOpacityDDBtn, mMaskBufferUnitWidget);
        QWidget::setTabOrder(mMaskBufferUnitWidget, mMaskJoinStyleDDBtn);
        QWidget::setTabOrder(mMaskJoinStyleDDBtn, mMaskBufferUnitsDDBtn);
        QWidget::setTabOrder(mMaskBufferUnitsDDBtn, mMaskBufferSizeSpinBox);
        QWidget::setTabOrder(mMaskBufferSizeSpinBox, mMaskBufferSizeDDBtn);
        QWidget::setTabOrder(mMaskBufferSizeDDBtn, mMaskOpacityWidget);
        QWidget::setTabOrder(mMaskOpacityWidget, scrollArea_6);
        ...
        QWidget::setTabOrder(mCalloutStyleComboBox, mChkNoObstacle);
        QWidget::setTabOrder(mChkNoObstacle, mIsObstacleDDBtn);
        QWidget::setTabOrder(mIsObstacleDDBtn, mObstacleSettingsButton);
        QWidget::setTabOrder(mObstacleSettingsButton, mLineAnchorSettingsButton);
    ...
    {
        QgsTextFormatWidgetBase->setWindowTitle(QApplication::translate("QgsTextFormatWidgetBase", "Layer Labeling Settings", Q_NULLPTR));
        label_12->setText(QApplication::translate("QgsTextFormatWidgetBase", "Value", Q_NULLPTR));
        groupBox_mPreview->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Text Sample", Q_NULLPTR));
        lblFontPreview->setText(QApplication::translate("QgsTextFormatWidgetBase", "Lorem Ipsum", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mPreviewTextEdit->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Sample text", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mPreviewTextEdit->setText(QApplication::translate("QgsTextFormatWidgetBase", "Lorem Ipsum", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mPreviewTextBtn->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Reset sample text", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mPreviewTextBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mPreviewScaleComboBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Preview text at specific map scale", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        mPreviewBackgroundBtn->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Sample background color", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        mOptionsTab->setTabToolTip(mOptionsTab->indexOf(callouts), QApplication::translate("QgsTextFormatWidgetBase", "Callouts", Q_NULLPTR));
        ...
        ___qlistwidgetitem->setText(QApplication::translate("QgsTextFormatWidgetBase", "Text", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Text style", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem1 = mLabelingOptionsListWidget->item(1);
        ___qlistwidgetitem1->setText(QApplication::translate("QgsTextFormatWidgetBase", "Formatting", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem1->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Formatting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem2 = mLabelingOptionsListWidget->item(2);
        ___qlistwidgetitem2->setText(QApplication::translate("QgsTextFormatWidgetBase", "Buffer", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem2->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Buffer", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem3 = mLabelingOptionsListWidget->item(3);
        ___qlistwidgetitem3->setText(QApplication::translate("QgsTextFormatWidgetBase", "Mask", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem4 = mLabelingOptionsListWidget->item(4);
        ___qlistwidgetitem4->setText(QApplication::translate("QgsTextFormatWidgetBase", "Background", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem4->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Background", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem5 = mLabelingOptionsListWidget->item(5);
        ___qlistwidgetitem5->setText(QApplication::translate("QgsTextFormatWidgetBase", "Shadow", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem5->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Shadow", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem6 = mLabelingOptionsListWidget->item(6);
        ___qlistwidgetitem6->setText(QApplication::translate("QgsTextFormatWidgetBase", "Callouts", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem6->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Callouts", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem7 = mLabelingOptionsListWidget->item(7);
        ___qlistwidgetitem7->setText(QApplication::translate("QgsTextFormatWidgetBase", "Placement", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem7->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Placement", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem8 = mLabelingOptionsListWidget->item(8);
        ___qlistwidgetitem8->setText(QApplication::translate("QgsTextFormatWidgetBase", "Rendering", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem8->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Rendering", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mLabelingOptionsListWidget->setSortingEnabled(__sortingEnabled);

        mFontOpacityDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontSizeLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Size", Q_NULLPTR));
        mFontSizeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Font", Q_NULLPTR));
        mFontMissingLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Font is missing.", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontUnderlineBtn->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Underlined text", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontUnderlineBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "U", Q_NULLPTR));
        mFontUnderlineDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontStrikethroughBtn->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Strikeout text", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontStrikethroughBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "S", Q_NULLPTR));
        mFontStrikeoutDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontBoldBtn->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Bold text\n"
"(data defined only, overrides Style)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontBoldBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "B", Q_NULLPTR));
        mFontBoldDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontItalicBtn->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Italic text\n"
"(data defined only, overrides Style)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontItalicBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "I", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontStyleComboBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Available typeface styles", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontTranspLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Opacity", Q_NULLPTR));
        mFontDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mHtmlFormattingCheckBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "If enabled, a subset of HTML formatting tags can be used to style text", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mHtmlFormattingCheckBox->setText(QApplication::translate("QgsTextFormatWidgetBase", "Allow HTML formatting", Q_NULLPTR));
        mFontStyleDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontColorLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Color", Q_NULLPTR));
        mFontLabel_2->setText(QApplication::translate("QgsTextFormatWidgetBase", "Text", Q_NULLPTR));
        mFontStyleLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Style", Q_NULLPTR));
        mFontColorDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontItalicDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_36->setText(QApplication::translate("QgsTextFormatWidgetBase", "Formatting", Q_NULLPTR));
        mFontCapitalsLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Type case", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mToolButtonConfigureSubstitutes->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Configure substitutes", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mToolButtonConfigureSubstitutes->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mDirectSymbDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mDirectSymbChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Line direction symbol", Q_NULLPTR));
        mDirectSymbRightLineEdit->setText(QApplication::translate("QgsTextFormatWidgetBase", ">", Q_NULLPTR));
        mDirectSymbRightToolBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mDirectSymbPlacementDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mDirectSymbLeftDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mDirectSymbLeftLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Left", Q_NULLPTR));
        mDirectSymbRightLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Right", Q_NULLPTR));
        mDirectSymbPlacementLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Placement", Q_NULLPTR));
        mDirectSymbRevChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Reverse direction", Q_NULLPTR));
        mDirectSymbRightDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mDirectSymbLeftLineEdit->setText(QApplication::translate("QgsTextFormatWidgetBase", "<", Q_NULLPTR));
        mDirectSymbLeftToolBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mDirectSymbRevDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mDirectSymbRadioBtnLR->setText(QApplication::translate("QgsTextFormatWidgetBase", "left/right", Q_NULLPTR));
        mDirectSymbRadioBtnAbove->setText(QApplication::translate("QgsTextFormatWidgetBase", "above", Q_NULLPTR));
        mDirectSymbRadioBtnBelow->setText(QApplication::translate("QgsTextFormatWidgetBase", "below", Q_NULLPTR));
        mFontCaseDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        labelTextOrientation->setText(QApplication::translate("QgsTextFormatWidgetBase", "Text orientation", Q_NULLPTR));
        mFontLetterSpacingLabel_3->setText(QApplication::translate("QgsTextFormatWidgetBase", "letter", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontLetterSpacingSpinBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Space in pixels or map units, relative to size unit choice", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mTextOrientationDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        labelBlendMode->setText(QApplication::translate("QgsTextFormatWidgetBase", "Blend mode", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mCheckBoxSubstituteText->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "If enabled, the label text will automatically be modified using a preset list of substitutes", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mCheckBoxSubstituteText->setText(QApplication::translate("QgsTextFormatWidgetBase", "Apply label text substitutes", Q_NULLPTR));
        mFontWordSpacingDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontLetterSpacingDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFormatNumChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Formatted numbers", Q_NULLPTR));
        mFormatNumDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFormatNumDecimalsLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Decimal places ", Q_NULLPTR));
        mFormatNumDecimalsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFormatNumPlusSignChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Show plus sign", Q_NULLPTR));
        mFormatNumPlusSignDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontWordSpacingLabel_3->setText(QApplication::translate("QgsTextFormatWidgetBase", "word", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontWordSpacingSpinBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Space in pixels or map units, relative to size unit choice", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        mFontCapitalsComboBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Capitalization style of text", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_24->setText(QApplication::translate("QgsTextFormatWidgetBase", "Multiple lines", Q_NULLPTR));
        mLabelWrapLinesTo->setText(QApplication::translate("QgsTextFormatWidgetBase", "Wrap lines to", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontMultiLineAlignComboBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Paragraph style alignment of multi-line text", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontMultiLineLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Alignment", Q_NULLPTR));
        mFontLineHeightDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mAutoWrapTypeComboBox->clear();
        mAutoWrapTypeComboBox->insertItems(0, QStringList()
         << QApplication::translate("QgsTextFormatWidgetBase", "Maximum line length", Q_NULLPTR)
         << QApplication::translate("QgsTextFormatWidgetBase", "Minimum line length", Q_NULLPTR)
        );
#ifndef QT_NO_TOOLTIP
        mAutoWrapTypeComboBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Controls whether lines are automatically wrapped using the maximum number of characters in a line, or the minimum", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mWrapCharDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontMultiLineAlignDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mAutoWrapLengthSpinBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "If set, label text will automatically be wrapped to match the specified number of characters per line (if possible)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mAutoWrapLengthSpinBox->setSpecialValueText(QApplication::translate("QgsTextFormatWidgetBase", "No automatic wrapping", Q_NULLPTR));
        mAutoWrapLengthSpinBox->setSuffix(QApplication::translate("QgsTextFormatWidgetBase", " characters", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontLineHeightSpinBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Line height spacing for multi-line text", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontLineHeightSpinBox->setSuffix(QApplication::translate("QgsTextFormatWidgetBase", " line", Q_NULLPTR));
        mFontLineHeightLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Line height", Q_NULLPTR));
        mLabelWrapOnCharacter->setText(QApplication::translate("QgsTextFormatWidgetBase", "Wrap on character", Q_NULLPTR));
        mAutoWrapLengthDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_10->setText(QApplication::translate("QgsTextFormatWidgetBase", "Spacing", Q_NULLPTR));
        mFontBlendModeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mKerningCheckBox->setText(QApplication::translate("QgsTextFormatWidgetBase", "Enable kerning", Q_NULLPTR));
        mBufferDrawDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mBufferDrawChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Draw text buffer", Q_NULLPTR));
        mBufferColorDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mBufferBlendModeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mBufferSizeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        labelBufferBlend->setText(QApplication::translate("QgsTextFormatWidgetBase", "Blend mode", Q_NULLPTR));
        btnBufferColor->setText(QString());
        label_5->setText(QApplication::translate("QgsTextFormatWidgetBase", "Pen join style", Q_NULLPTR));
        mBufferTranspFillChbx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Color buffer's fill", Q_NULLPTR));
        label_31->setText(QApplication::translate("QgsTextFormatWidgetBase", "Size", Q_NULLPTR));
        mBufferJoinStyleDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mBufferUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_32->setText(QApplication::translate("QgsTextFormatWidgetBase", "Color", Q_NULLPTR));
        spinBufferSize->setSuffix(QString());
        mBufferOpacityDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mBufferTranspLabel_2->setText(QApplication::translate("QgsTextFormatWidgetBase", "Opacity", Q_NULLPTR));
        label_37->setText(QApplication::translate("QgsTextFormatWidgetBase", "Buffer", Q_NULLPTR));
        label_99->setText(QApplication::translate("QgsTextFormatWidgetBase", "Mask", Q_NULLPTR));
        mEnableMaskDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mEnableMaskChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Enable mask", Q_NULLPTR));
        mMaskOpacityDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mMaskJoinStyleDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mMaskBufferUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mMaskBufferSizeSpinBox->setSuffix(QString());
        mMaskBufferSizeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_311->setText(QApplication::translate("QgsTextFormatWidgetBase", "Size", Q_NULLPTR));
        label_51->setText(QApplication::translate("QgsTextFormatWidgetBase", "Pen join style", Q_NULLPTR));
        mMaskTranspLabel_2->setText(QApplication::translate("QgsTextFormatWidgetBase", "Opacity", Q_NULLPTR));
        label->setText(QApplication::translate("QgsTextFormatWidgetBase", "<html><head/><body><p>This mask shape should then be selected as a <span style=\" font-style:italic;\">mask source</span> in the Masks properties of a layer in order to enable masking.</p></body></html>", Q_NULLPTR));
        mShapeDrawChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Draw background", Q_NULLPTR));
        mShapeDrawDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeOffsetDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeStrokeWidthLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Stroke width", Q_NULLPTR));
        mShapeRadiusLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Radius X,Y", Q_NULLPTR));
        mShapeSVGParamsBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "Load symbol parameters", Q_NULLPTR));
        mShapeSizeXDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeFillColorLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Fill color", Q_NULLPTR));
        mShapeSizeYDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeSizeCmbBx->clear();
        mShapeSizeCmbBx->insertItems(0, QStringList()
         << QApplication::translate("QgsTextFormatWidgetBase", "Buffer", Q_NULLPTR)
         << QApplication::translate("QgsTextFormatWidgetBase", "Fixed", Q_NULLPTR)
        );
        label_23->setText(QApplication::translate("QgsTextFormatWidgetBase", "Rotation", Q_NULLPTR));
        mShapeRotationTypeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeSVGUnitsLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "symbol units", Q_NULLPTR));
        mShapeSVGSelectorBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeSVGPathDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeFillColorDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapePenStyleLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Pen join style", Q_NULLPTR));
        mShapeStrokeUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_8->setText(QApplication::translate("QgsTextFormatWidgetBase", "Size type", Q_NULLPTR));
        mShapeStrokeWidthDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeSizeTypeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_22->setText(QApplication::translate("QgsTextFormatWidgetBase", "Shape", Q_NULLPTR));
        mShapeRadiusUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeRotationDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeOffsetXSpnBx->setSuffix(QString());
        mShapeOffsetYSpnBx->setSuffix(QString());
        label_21->setText(QApplication::translate("QgsTextFormatWidgetBase", "Offset X,Y", Q_NULLPTR));
        mShapeSizeXLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Size X", Q_NULLPTR));
        mShapeSizeXSpnBx->setSuffix(QString());
        mShapeOffsetUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeRotationCmbBx->clear();
        mShapeRotationCmbBx->insertItems(0, QStringList()
         << QApplication::translate("QgsTextFormatWidgetBase", "Sync with label", Q_NULLPTR)
         << QApplication::translate("QgsTextFormatWidgetBase", "Offset of label", Q_NULLPTR)
         << QApplication::translate("QgsTextFormatWidgetBase", "Fixed", Q_NULLPTR)
        );
        mShapeStrokeColorLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Stroke color", Q_NULLPTR));
        mShapeSizeUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeBlendModeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_18->setText(QApplication::translate("QgsTextFormatWidgetBase", "Blend mode", Q_NULLPTR));
        mShapeOpacityDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeStrokeColorDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeTranspLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Opacity", Q_NULLPTR));
        mShapeSizeYLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Size Y", Q_NULLPTR));
        mShapeTypeDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapeSizeYSpnBx->setSuffix(QString());
        mShapeRadiusDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShapePenStyleDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mBackgroundSymbolButton->setText(QApplication::translate("QgsTextFormatWidgetBase", "Background Symbol\342\200\246", Q_NULLPTR));
        label_38->setText(QApplication::translate("QgsTextFormatWidgetBase", "Background", Q_NULLPTR));
        mShadowDrawChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Draw drop shadow", Q_NULLPTR));
        mShadowDrawDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_29->setText(QApplication::translate("QgsTextFormatWidgetBase", "Scale", Q_NULLPTR));
        label_27->setText(QApplication::translate("QgsTextFormatWidgetBase", "Blur radius", Q_NULLPTR));
        mShadowRadiusAlphaChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Blur only alpha pixels", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mShadowOffsetGlobalChkBx->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Label's rotation is ignored", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mShadowOffsetGlobalChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Use global shadow", Q_NULLPTR));
        mShadowOffsetAngleSpnBx->setSuffix(QApplication::translate("QgsTextFormatWidgetBase", "\313\232", Q_NULLPTR));
        label_17->setText(QApplication::translate("QgsTextFormatWidgetBase", "Draw under", Q_NULLPTR));
        mShadowScaleSpnBx->setSuffix(QApplication::translate("QgsTextFormatWidgetBase", " %", Q_NULLPTR));
        label_30->setText(QApplication::translate("QgsTextFormatWidgetBase", "Blend mode", Q_NULLPTR));
        label_9->setText(QApplication::translate("QgsTextFormatWidgetBase", "Offset", Q_NULLPTR));
        label_33->setText(QApplication::translate("QgsTextFormatWidgetBase", "Color", Q_NULLPTR));
        label_28->setText(QApplication::translate("QgsTextFormatWidgetBase", "Opacity", Q_NULLPTR));
        mShadowUnderDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowOffsetAngleDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowOffsetDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowOffsetUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowRadiusDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowRadiusUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowOpacityDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowScaleDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowColorDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mShadowBlendDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_39->setText(QApplication::translate("QgsTextFormatWidgetBase", "Shadow", Q_NULLPTR));
        mCalloutsDrawCheckBox->setText(QApplication::translate("QgsTextFormatWidgetBase", "Draw callouts", Q_NULLPTR));
        label_511->setText(QApplication::translate("QgsTextFormatWidgetBase", "Callouts", Q_NULLPTR));
        mCalloutDrawDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_45->setText(QApplication::translate("QgsTextFormatWidgetBase", "This callout type doesn't have any editable properties", Q_NULLPTR));
        label_11->setText(QApplication::translate("QgsTextFormatWidgetBase", "Style", Q_NULLPTR));
        label_43->setText(QApplication::translate("QgsTextFormatWidgetBase", "Placement", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "General Settings", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mPlacementPolygonFrame->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Allowed label placement for lines. At least one position must be selected.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mCheckAllowLabelsOutsidePolygons->setText(QApplication::translate("QgsTextFormatWidgetBase", "Allow placing labels outside of polygons", Q_NULLPTR));
        mAllowOutsidePolygonsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_14->setText(QApplication::translate("QgsTextFormatWidgetBase", "<html><head/><body><p><span style=\" font-weight:600;\">The Placement Mode option controls the overall placement of labels relative to their corresponding features.</span></p></body></html>", Q_NULLPTR));
        mCentroidRadioVisible->setText(QApplication::translate("QgsTextFormatWidgetBase", "visible polygon", Q_NULLPTR));
        mCentroidDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mCentroidRadioWhole->setText(QApplication::translate("QgsTextFormatWidgetBase", "whole polygon", Q_NULLPTR));
        mCentroidInsideCheckBox->setText(QApplication::translate("QgsTextFormatWidgetBase", "Force point inside polygon", Q_NULLPTR));
        mCentroidLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Centroid", Q_NULLPTR));
        label_2->setText(QApplication::translate("QgsTextFormatWidgetBase", "Mode", Q_NULLPTR));
        mPointQuadOffsetDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mPointOffsetOver->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mPointOffsetAboveRight->setText(QApplication::translate("QgsTextFormatWidgetBase", "abc", Q_NULLPTR));
        mPointOffsetBelowLeft->setText(QApplication::translate("QgsTextFormatWidgetBase", "abc", Q_NULLPTR));
        mPointOffsetLeft->setText(QApplication::translate("QgsTextFormatWidgetBase", "abc", Q_NULLPTR));
        mPointOffsetAboveLeft->setText(QApplication::translate("QgsTextFormatWidgetBase", "abc", Q_NULLPTR));
        mPointOffsetRight->setText(QApplication::translate("QgsTextFormatWidgetBase", "abc", Q_NULLPTR));
        mPointOffsetBelow->setText(QApplication::translate("QgsTextFormatWidgetBase", "abc", Q_NULLPTR));
        mPointOffsetBelowRight->setText(QApplication::translate("QgsTextFormatWidgetBase", "abc", Q_NULLPTR));
        mPointOffsetAbove->setText(QApplication::translate("QgsTextFormatWidgetBase", "abc", Q_NULLPTR));
        label_6->setText(QApplication::translate("QgsTextFormatWidgetBase", "Quadrant", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mPlacementLineFrame->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Allowed label placement for lines. At least one position must be selected.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        chkLineOrientationDependent->setText(QApplication::translate("QgsTextFormatWidgetBase", "Line orientation dependent position", Q_NULLPTR));
        chkLineAbove->setText(QApplication::translate("QgsTextFormatWidgetBase", "Above line", Q_NULLPTR));
        chkLineOn->setText(QApplication::translate("QgsTextFormatWidgetBase", "On line", Q_NULLPTR));
        chkLineBelow->setText(QApplication::translate("QgsTextFormatWidgetBase", "Below line", Q_NULLPTR));
        mLinePlacementFlagsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_13->setText(QApplication::translate("QgsTextFormatWidgetBase", "Allowed positions", Q_NULLPTR));
        label_42->setText(QApplication::translate("QgsTextFormatWidgetBase", "Distance offset from", Q_NULLPTR));
        mPointOffsetYSpinBox->setPrefix(QString());
        mPointOffsetYSpinBox->setSuffix(QString());
        mPointOffsetDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mPointOffsetUnitsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mPointOffsetXSpinBox->setPrefix(QString());
        mPointOffsetXSpinBox->setSuffix(QString());
        label_15->setText(QApplication::translate("QgsTextFormatWidgetBase", "Offset X,Y", Q_NULLPTR));
        label_26->setText(QApplication::translate("QgsTextFormatWidgetBase", "Distance", Q_NULLPTR));
        mLineDistanceDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mLineDistanceUnitDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mPointPositionOrderDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_20->setText(QApplication::translate("QgsTextFormatWidgetBase", "Position priority", Q_NULLPTR));
        mPlacementModeDescriptionLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "TextLabel", Q_NULLPTR));
        label_25->setText(QApplication::translate("QgsTextFormatWidgetBase", "Rotation", Q_NULLPTR));
        mPointAngleSpinBox->setSuffix(QApplication::translate("QgsTextFormatWidgetBase", "\313\232", Q_NULLPTR));
        mPlacementRepeatGroupBox->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Repeating Labels", Q_NULLPTR));
        mRepeatDistanceSpinBox->setSpecialValueText(QApplication::translate("QgsTextFormatWidgetBase", "No repeat", Q_NULLPTR));
        mRepeatDistanceDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_7->setText(QApplication::translate("QgsTextFormatWidgetBase", "Distance", Q_NULLPTR));
        mRepeatDistanceUnitDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_41->setText(QApplication::translate("QgsTextFormatWidgetBase", "Setting a repeat distance allows labels to be repeated multiple times over the length of the feature. This distance is treated as a hint for label placement only, and the exact distance between repeating labels may vary depending on the shape of the feature and arrangement of nearby labels.", Q_NULLPTR));
        mPlacementOverrunGroupBox->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Label Overrun", Q_NULLPTR));
        label_46->setText(QApplication::translate("QgsTextFormatWidgetBase", "Overrun distance", Q_NULLPTR));
        mOverrunDistanceSpinBox->setSpecialValueText(QApplication::translate("QgsTextFormatWidgetBase", "No overrun", Q_NULLPTR));
        mOverrunDistanceDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        label_40->setText(QApplication::translate("QgsTextFormatWidgetBase", "The overrun distance allows labels which extend past the start or end of line features. Increasing this distance can allow for labels to be shown for shorter line features.", Q_NULLPTR));
        mLineAnchorGroupBox->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Label Anchoring", Q_NULLPTR));
        mLblPlacementAlongLine->setText(QApplication::translate("QgsTextFormatWidgetBase", "Controls the placement of labels along line features", Q_NULLPTR));
        mLineAnchorSettingsButton->setText(QApplication::translate("QgsTextFormatWidgetBase", "Settings\342\200\246", Q_NULLPTR));
        mMaxCharAngleOutLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "outside", Q_NULLPTR));
        mMaxCharAngleInLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "inside", Q_NULLPTR));
        mMaxCharAngleDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mMaxCharAngleLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Maximum angle between curved characters", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mGeometryGeneratorGroupBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "<html><head/><body><p><span style=\" font-weight:600;\">Generates or transforms the geometry to be used for labeling</span></p><p><br/></p><p>The expression will be applied to each feature while rendering and the label will be placed based on the expression result.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mGeometryGeneratorGroupBox->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Geometry Generator", Q_NULLPTR));
        mGeometryGeneratorExpressionButton->setText(QApplication::translate("QgsTextFormatWidgetBase", "...", Q_NULLPTR));
        mGeometryGeneratorWarningLabel->setText(QString());
        mPlacementDDGroupBox->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Data defined", Q_NULLPTR));
        mCoordAlignmentLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Alignment", Q_NULLPTR));
        mCoordLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Coordinate", Q_NULLPTR));
        mCoordRotationLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Rotation", Q_NULLPTR));
        mCoordAlignmentHLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "horizontal", Q_NULLPTR));
        mCoordAlignmentHDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mCoordAlignmentVLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "vertical", Q_NULLPTR));
        mCoordAlignmentVDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mCoordXLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "X", Q_NULLPTR));
        mCoordXDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mCoordYLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Y", Q_NULLPTR));
        mCoordYDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mCoordRotationDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        chkPreserveRotation->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Uncheck to write labeling engine derived rotation on pin and NULL on unpin", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        chkPreserveRotation->setText(QApplication::translate("QgsTextFormatWidgetBase", "Preserve data rotation values", Q_NULLPTR));
        mPriorityGrpBx->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Priority", Q_NULLPTR));
        label_34->setText(QApplication::translate("QgsTextFormatWidgetBase", "Low", Q_NULLPTR));
        label_35->setText(QApplication::translate("QgsTextFormatWidgetBase", "High", Q_NULLPTR));
        mPriorityDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mObstaclesGroupBox->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Obstacles", Q_NULLPTR));
        mLblNoObstacle->setText(QApplication::translate("QgsTextFormatWidgetBase", "When activated, features acting as obstacles discourage labels and diagrams from covering them.", Q_NULLPTR));
        mLblNoObstacle1->setText(QApplication::translate("QgsTextFormatWidgetBase", "Features act as obstacles", Q_NULLPTR));
        mIsObstacleDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mObstacleSettingsButton->setText(QApplication::translate("QgsTextFormatWidgetBase", "Settings\342\200\246", Q_NULLPTR));
        label_4->setText(QApplication::translate("QgsTextFormatWidgetBase", "Rendering", Q_NULLPTR));
        mRenderingLabelGrpBx->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Label options", Q_NULLPTR));
        mScaleBasedVisibilityChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Scale dependent visibility", Q_NULLPTR));
        mScaleBasedVisibilityDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mMaxScaleWidget->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Maximum scale, i.e. most \"zoomed in\".", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mScaleBasedVisibilityMaxDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mMinScaleWidget->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Minimum scale, i.e. most \"zoomed out\".", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mScaleBasedVisibilityMinDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mLabelMinScale->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Minimum scale, i.e. most \"zoomed out\".", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mLabelMinScale->setText(QString());
#ifndef QT_NO_TOOLTIP
        mLabelMaxScale->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Maximum scale, i.e. most \"zoomed in\".", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mLabelMaxScale->setText(QString());
#ifndef QT_NO_TOOLTIP
        mFontMinPixelSpinBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Labels will not show if smaller than this on screen", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontMinPixelSpinBox->setSuffix(QApplication::translate("QgsTextFormatWidgetBase", " px", Q_NULLPTR));
        mFontMinPixelSpinBox->setPrefix(QApplication::translate("QgsTextFormatWidgetBase", "Minimum ", Q_NULLPTR));
        mFontMinPixelDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mFontMaxPixelSpinBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Labels will not show if larger than this on screen", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mFontMaxPixelSpinBox->setSuffix(QApplication::translate("QgsTextFormatWidgetBase", " px", Q_NULLPTR));
        mFontMaxPixelSpinBox->setPrefix(QApplication::translate("QgsTextFormatWidgetBase", "Maximum ", Q_NULLPTR));
        mFontMaxPixelDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontLimitPixelDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mFontLimitPixelChkBox->setText(QApplication::translate("QgsTextFormatWidgetBase", "Pixel size-based visibility (labels in map units)", Q_NULLPTR));
        label_16->setText(QApplication::translate("QgsTextFormatWidgetBase", "Label z-index", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mZIndexSpinBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Controls how labels are drawn on top of each other. Labels with a higher z-index are drawn above labels and diagrams with a lower z-index.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mZIndexDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mPalShowAllLabelsForLayerChkBx->setText(QApplication::translate("QgsTextFormatWidgetBase", "Show all labels for this layer (including colliding labels)", Q_NULLPTR));
        mShowLabelDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mAlwaysShowDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        mAlwaysShowLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Always show", Q_NULLPTR));
        mShowLabelLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Show label", Q_NULLPTR));
        label_3->setText(QApplication::translate("QgsTextFormatWidgetBase", "Data defined", Q_NULLPTR));
        mUpsidedownRadioAll->setText(QApplication::translate("QgsTextFormatWidgetBase", "always", Q_NULLPTR));
        mUpsidedownRadioOff->setText(QApplication::translate("QgsTextFormatWidgetBase", "never", Q_NULLPTR));
        mUpsidedownRadioDefined->setText(QApplication::translate("QgsTextFormatWidgetBase", "when rotation defined", Q_NULLPTR));
        mUpsidedownLabel->setText(QApplication::translate("QgsTextFormatWidgetBase", "Show upside-down labels", Q_NULLPTR));
        mRenderingFeaturesGrpBx->setTitle(QApplication::translate("QgsTextFormatWidgetBase", "Feature options", Q_NULLPTR));
        chkLabelPerFeaturePart->setText(QApplication::translate("QgsTextFormatWidgetBase", "Label every part of multi-part features", Q_NULLPTR));
        mLabelAllPartsDDBtn->setText(QApplication::translate("QgsTextFormatWidgetBase", "\342\200\246", Q_NULLPTR));
        chkMergeLines->setText(QApplication::translate("QgsTextFormatWidgetBase", "Merge connected lines to avoid duplicate labels", Q_NULLPTR));
        mFitInsidePolygonCheckBox->setText(QApplication::translate("QgsTextFormatWidgetBase", "Only draw labels which fit completely within feature", Q_NULLPTR));
        mMinSizeSpinBox->setSuffix(QApplication::translate("QgsTextFormatWidgetBase", " mm", Q_NULLPTR));
        label_19->setText(QApplication::translate("QgsTextFormatWidgetBase", "Suppress labeling of features smaller than", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mLimitLabelSpinBox->setToolTip(QApplication::translate("QgsTextFormatWidgetBase", "Number of features sent to labeling engine, though not all may be labeled", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mLimitLabelChkBox->setText(QApplication::translate("QgsTextFormatWidgetBase", "Limit number of features to be labeled to", Q_NULLPTR));
    } // retranslateUi
