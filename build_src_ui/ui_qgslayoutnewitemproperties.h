...
public:
    ...
    {
        QgsLayoutNewItemPropertiesDialog->setWindowTitle(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "New Item Properties", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "Reference Point", Q_NULLPTR));
        ...
        groupBox->setTitle(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "Position and Size", Q_NULLPTR));
        mYPosSpin->setSuffix(QString());
        mHeightLabel->setText(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "Height", Q_NULLPTR));
        mWidthSpin->setSuffix(QString());
        mWidthLabel->setText(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "Width", Q_NULLPTR));
        mYLabel->setText(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "Y", Q_NULLPTR));
        mXLabel->setText(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "X", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mLockAspectRatio->setToolTip(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "Lock aspect ratio (including while drawing extent onto canvas)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mHeightSpin->setSuffix(QString());
        mXPosSpin->setSuffix(QString());
        label->setText(QApplication::translate("QgsLayoutNewItemPropertiesDialog", "Page", Q_NULLPTR));
    } // retranslateUi
