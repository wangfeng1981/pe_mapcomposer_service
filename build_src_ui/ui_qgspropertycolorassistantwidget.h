...
public:
    ...
    void setupUi(QWidget *PropertyColorAssistant)
    {
        if (PropertyColorAssistant->objectName().isEmpty())
            PropertyColorAssistant->setObjectName(QStringLiteral("PropertyColorAssistant"));
        ...
        mNullColorButton->setObjectName(QStringLiteral("mNullColorButton"));
        ...
        mColorRampButton->setObjectName(QStringLiteral("mColorRampButton"));
    ...
    {
        label_8->setText(QApplication::translate("PropertyColorAssistant", "Color when NULL", Q_NULLPTR));
        mNullColorButton->setText(QString());
        label->setText(QApplication::translate("PropertyColorAssistant", "Color ramp", Q_NULLPTR));
        Q_UNUSED(PropertyColorAssistant);
    } // retranslateUi
