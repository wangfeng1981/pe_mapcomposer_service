...
public:
    ...
    void setupUi(QWidget *QgsAuthSslConfigWidget)
    {
        ...
        QgsAuthSslConfigWidget->setWindowTitle(QStringLiteral("Form"));
    ...
    void retranslateUi(QWidget *QgsAuthSslConfigWidget)
    {
        ...
        btnCertInfo->setToolTip(QApplication::translate("QgsAuthSslConfigWidget", "Show information for certificate", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        Q_UNUSED(QgsAuthSslConfigWidget);
    } // retranslateUi
