...
public:
    ...
    void setupUi(QWidget *WidgetRasterMarker)
    {
        if (WidgetRasterMarker->objectName().isEmpty())
            WidgetRasterMarker->setObjectName(QStringLiteral("WidgetRasterMarker"));
        WidgetRasterMarker->resize(338, 439);
        WidgetRasterMarker->setWindowTitle(QStringLiteral("Form"));
        ...
        mWidthSpinBox->setMaximum(100000);
        ...
        mHeightSpinBox->setMaximum(100000);
    ...
    {
        mAnchorPointLabel->setText(QApplication::translate("WidgetRasterMarker", "Anchor point", Q_NULLPTR));
        mLabelImagePreview->setText(QString());
        label_2->setText(QApplication::translate("WidgetRasterMarker", "x", Q_NULLPTR));
        label_4->setText(QApplication::translate("WidgetRasterMarker", "y", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mLockAspectRatio->setToolTip(QApplication::translate("WidgetRasterMarker", "Lock aspect ratio", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mWidthDDBtn->setText(QApplication::translate("WidgetRasterMarker", "\342\200\246", Q_NULLPTR));
        mHeightDDBtn->setText(QApplication::translate("WidgetRasterMarker", "\342\200\246", Q_NULLPTR));
        label_10->setText(QApplication::translate("WidgetRasterMarker", "Width", Q_NULLPTR));
        label_11->setText(QApplication::translate("WidgetRasterMarker", "Height", Q_NULLPTR));
        label_13->setText(QApplication::translate("WidgetRasterMarker", "Unit", Q_NULLPTR));
        mHorizontalAnchorComboBox->clear();
        mHorizontalAnchorComboBox->insertItems(0, QStringList()
         << QApplication::translate("WidgetRasterMarker", "Left", Q_NULLPTR)
         << QApplication::translate("WidgetRasterMarker", "HCenter", Q_NULLPTR)
         << QApplication::translate("WidgetRasterMarker", "Right", Q_NULLPTR)
        );
        mVerticalAnchorDDBtn->setText(QApplication::translate("WidgetRasterMarker", "\342\200\246", Q_NULLPTR));
        mRotationLabel->setText(QApplication::translate("WidgetRasterMarker", "Rotation", Q_NULLPTR));
        mFilenameDDBtn->setText(QApplication::translate("WidgetRasterMarker", "\342\200\246", Q_NULLPTR));
        mOffsetDDBtn->setText(QApplication::translate("WidgetRasterMarker", "\342\200\246", Q_NULLPTR));
        mTextureWidthLabel->setText(QApplication::translate("WidgetRasterMarker", "Size", Q_NULLPTR));
        label->setText(QApplication::translate("WidgetRasterMarker", "Opacity", Q_NULLPTR));
        mHorizontalAnchorDDBtn->setText(QApplication::translate("WidgetRasterMarker", "\342\200\246", Q_NULLPTR));
        mVerticalAnchorComboBox->clear();
        mVerticalAnchorComboBox->insertItems(0, QStringList()
         << QApplication::translate("WidgetRasterMarker", "Top", Q_NULLPTR)
         << QApplication::translate("WidgetRasterMarker", "VCenter", Q_NULLPTR)
         << QApplication::translate("WidgetRasterMarker", "Bottom", Q_NULLPTR)
        );
        mRotationDDBtn->setText(QApplication::translate("WidgetRasterMarker", "\342\200\246", Q_NULLPTR));
        label_7->setText(QApplication::translate("WidgetRasterMarker", "Offset", Q_NULLPTR));
        mRotationSpinBox->setSuffix(QApplication::translate("WidgetRasterMarker", " \302\260", Q_NULLPTR));
        mOpacityDDBtn->setText(QApplication::translate("WidgetRasterMarker", "\342\200\246", Q_NULLPTR));
        Q_UNUSED(WidgetRasterMarker);
    } // retranslateUi
