...
public:
    ...
    void setupUi(QDialog *QgsNewOgrConnectionBase)
    {
        if (QgsNewOgrConnectionBase->objectName().isEmpty())
            QgsNewOgrConnectionBase->setObjectName(QStringLiteral("QgsNewOgrConnectionBase"));
        ...
        grLayout1->setObjectName(QStringLiteral("grLayout1"));
        ...
        mAuthSettingsDatabase->setObjectName(QStringLiteral("mAuthSettingsDatabase"));
        ...
        QWidget::setTabOrder(txtPort, buttonBox);
    ...
    {
        QgsNewOgrConnectionBase->setWindowTitle(QApplication::translate("QgsNewOgrConnectionBase", "Create a New OGR Database Connection", Q_NULLPTR));
        GroupBox1->setTitle(QApplication::translate("QgsNewOgrConnectionBase", "Connection Information", Q_NULLPTR));
        btnConnect->setText(QApplication::translate("QgsNewOgrConnectionBase", "&Test Connection", Q_NULLPTR));
        mAuthGroupBox->setTitle(QApplication::translate("QgsNewOgrConnectionBase", "Authentication", Q_NULLPTR));
        label->setText(QApplication::translate("QgsNewOgrConnectionBase", "&Type", Q_NULLPTR));
        TextLabel1_2->setText(QApplication::translate("QgsNewOgrConnectionBase", "&Name", Q_NULLPTR));
        TextLabel1->setText(QApplication::translate("QgsNewOgrConnectionBase", "Host", Q_NULLPTR));
        TextLabel2->setText(QApplication::translate("QgsNewOgrConnectionBase", "&Database", Q_NULLPTR));
        TextLabel2_2->setText(QApplication::translate("QgsNewOgrConnectionBase", "Port", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        txtName->setToolTip(QApplication::translate("QgsNewOgrConnectionBase", "Name of the new connection", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
