...
public:
    ...
    void setupUi(QWidget *PropertySizeAssistant)
    {
        if (PropertySizeAssistant->objectName().isEmpty())
            PropertySizeAssistant->setObjectName(QStringLiteral("PropertySizeAssistant"));
        ...
        maxSizeSpinBox->setMaximum(1e+8);
        ...
        nullSizeSpinBox->setObjectName(QStringLiteral("nullSizeSpinBox"));
        nullSizeSpinBox->setDecimals(6);
        nullSizeSpinBox->setMaximum(1e+8);
        nullSizeSpinBox->setSingleStep(0.1);
        ...
        scaleMethodComboBox->setObjectName(QStringLiteral("scaleMethodComboBox"));
        ...
        minSizeSpinBox->setMinimum(0);
        minSizeSpinBox->setMaximum(1e+8);
    ...
    {
        label_5->setText(QApplication::translate("PropertySizeAssistant", "Size from", Q_NULLPTR));
        label_8->setText(QApplication::translate("PropertySizeAssistant", "Size when NULL", Q_NULLPTR));
        label_2->setText(QApplication::translate("PropertySizeAssistant", "Exponent", Q_NULLPTR));
        label_6->setText(QApplication::translate("PropertySizeAssistant", "to", Q_NULLPTR));
        label->setText(QApplication::translate("PropertySizeAssistant", "Scale method", Q_NULLPTR));
        Q_UNUSED(PropertySizeAssistant);
    } // retranslateUi
