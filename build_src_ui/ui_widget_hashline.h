...
public:
    ...
    void setupUi(QWidget *WidgetHashedLine)
    {
        ...
        mSpinHashLength->setMaximum(1e+7);
        ...
        spinOffset->setMinimum(-1e+9);
        spinOffset->setMaximum(1e+9);
        ...
        mSpinAverageAngleLength->setMaximum(1e+7);
        ...
        mSpinOffsetAlongLine->setMaximum(1e+7);
    ...
    {
        label_2->setText(QApplication::translate("WidgetHashedLine", "Hash placement", Q_NULLPTR));
        radInterval->setText(QApplication::translate("WidgetHashedLine", "with interval", Q_NULLPTR));
        radVertex->setText(QApplication::translate("WidgetHashedLine", "on every vertex", Q_NULLPTR));
        radVertexLast->setText(QApplication::translate("WidgetHashedLine", "on last vertex only", Q_NULLPTR));
        radVertexFirst->setText(QApplication::translate("WidgetHashedLine", "on first vertex only", Q_NULLPTR));
        radCurvePoint->setText(QApplication::translate("WidgetHashedLine", "on every curve point", Q_NULLPTR));
        mIntervalDDBtn->setText(QApplication::translate("WidgetHashedLine", "\342\200\246", Q_NULLPTR));
        radCentralPoint->setText(QApplication::translate("WidgetHashedLine", "on central point", Q_NULLPTR));
        radSegmentCentralPoint->setText(QApplication::translate("WidgetHashedLine", "on central point of segments", Q_NULLPTR));
        mPlacementDDBtn->setText(QApplication::translate("WidgetHashedLine", "\342\200\246", Q_NULLPTR));
        mHashRotationDDBtn->setText(QApplication::translate("WidgetHashedLine", "\342\200\246", Q_NULLPTR));
        mAverageAngleDDBtn->setText(QApplication::translate("WidgetHashedLine", "\342\200\246", Q_NULLPTR));
        mOffsetAlongLineDDBtn->setText(QApplication::translate("WidgetHashedLine", "\342\200\246", Q_NULLPTR));
        label_3->setText(QApplication::translate("WidgetHashedLine", "Line offset", Q_NULLPTR));
        mHashLengthDDBtn->setText(QApplication::translate("WidgetHashedLine", "\342\200\246", Q_NULLPTR));
        mHashRotationSpinBox->setSuffix(QApplication::translate("WidgetHashedLine", " \302\260", Q_NULLPTR));
        label_4->setText(QApplication::translate("WidgetHashedLine", "Hash rotation", Q_NULLPTR));
        label->setText(QApplication::translate("WidgetHashedLine", "Offset along line", Q_NULLPTR));
        label_5->setText(QApplication::translate("WidgetHashedLine", "Hash length", Q_NULLPTR));
        mRingsLabel->setText(QApplication::translate("WidgetHashedLine", "Rings", Q_NULLPTR));
        label_6->setText(QApplication::translate("WidgetHashedLine", "Average angle over", Q_NULLPTR));
        mLineOffsetDDBtn->setText(QApplication::translate("WidgetHashedLine", "\342\200\246", Q_NULLPTR));
        chkRotateMarker->setText(QApplication::translate("WidgetHashedLine", "Rotate hash to follow line direction", Q_NULLPTR));
