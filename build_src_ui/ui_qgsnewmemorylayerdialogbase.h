...
public:
    ...
    void retranslateUi(QDialog *QgsNewMemoryLayerDialogBase)
    {
        ...
        groupBox->setTitle(QApplication::translate("QgsNewMemoryLayerDialogBase", "New Field", Q_NULLPTR));
        textLabel1->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Name", Q_NULLPTR));
        textLabel2->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Type", Q_NULLPTR));
        label_4->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Length", Q_NULLPTR));
        label_5->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Precision", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mAddAttributeButton->setToolTip(QApplication::translate("QgsNewMemoryLayerDialogBase", "Add field to list", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mAddAttributeButton->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Add to Fields List", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("QgsNewMemoryLayerDialogBase", "Fields List", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem = mAttributeView->headerItem();
        ___qtreewidgetitem->setText(3, QApplication::translate("QgsNewMemoryLayerDialogBase", "Precision", Q_NULLPTR));
        ___qtreewidgetitem->setText(2, QApplication::translate("QgsNewMemoryLayerDialogBase", "Length", Q_NULLPTR));
        ___qtreewidgetitem->setText(1, QApplication::translate("QgsNewMemoryLayerDialogBase", "Type", Q_NULLPTR));
        ___qtreewidgetitem->setText(0, QApplication::translate("QgsNewMemoryLayerDialogBase", "Name", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mRemoveAttributeButton->setToolTip(QApplication::translate("QgsNewMemoryLayerDialogBase", "Delete selected field", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mRemoveAttributeButton->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Remove Field", Q_NULLPTR));
