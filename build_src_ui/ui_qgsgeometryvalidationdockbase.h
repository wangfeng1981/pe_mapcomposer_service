...
public:
    ...
    {
        QgsGeometryValidationDockBase->setWindowTitle(QApplication::translate("QgsGeometryValidationDockBase", "Geometry Validation", Q_NULLPTR));
        mZoomToFeatureButton->setText(QApplication::translate("QgsGeometryValidationDockBase", "Zoom To Feature(s)", Q_NULLPTR));
        mNextButton->setText(QApplication::translate("QgsGeometryValidationDockBase", "Next", Q_NULLPTR));
        mZoomToProblemButton->setText(QApplication::translate("QgsGeometryValidationDockBase", "Zoom To Problem", Q_NULLPTR));
        mPreviousButton->setText(QApplication::translate("QgsGeometryValidationDockBase", "Previous", Q_NULLPTR));
        mProblemDescriptionLabel->setText(QApplication::translate("QgsGeometryValidationDockBase", "Detailed Description", Q_NULLPTR));
    } // retranslateUi
