...
public:
    ...
    void setupUi(QWidget *QgsExpressionPreviewWidgetBase)
    {
        if (QgsExpressionPreviewWidgetBase->objectName().isEmpty())
            QgsExpressionPreviewWidgetBase->setObjectName(QStringLiteral("QgsExpressionPreviewWidgetBase"));
        ...
        mPreviewLabel->setObjectName(QStringLiteral("mPreviewLabel"));
        ...
        mFeaturePickerWidget->setObjectName(QStringLiteral("mFeaturePickerWidget"));
    ...
    {
        QgsExpressionPreviewWidgetBase->setWindowTitle(QApplication::translate("QgsExpressionPreviewWidgetBase", "Expression Preview", Q_NULLPTR));
        label->setText(QApplication::translate("QgsExpressionPreviewWidgetBase", "Preview:", Q_NULLPTR));
        mPreviewLabel->setText(QApplication::translate("QgsExpressionPreviewWidgetBase", "TextLabel", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("QgsExpressionPreviewWidgetBase", "Select the feature to use for the output preview", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("QgsExpressionPreviewWidgetBase", "Feature", Q_NULLPTR));
    } // retranslateUi
