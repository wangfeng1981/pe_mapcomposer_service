...
public:
    ...
    {
        label_3->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Polyline", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("QgsLayoutPolylineWidgetBase", "Main Properties", Q_NULLPTR));
        mLineStyleButton->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Line Style\342\200\246", Q_NULLPTR));
        mArrowMarkersGroupBox->setTitle(QApplication::translate("QgsLayoutPolylineWidgetBase", "Line Markers", Q_NULLPTR));
        label_5->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Arrow stroke color", Q_NULLPTR));
        mStrokeWidthSpinBox->setPrefix(QString());
        mStrokeWidthSpinBox->setSuffix(QApplication::translate("QgsLayoutPolylineWidgetBase", " mm", Q_NULLPTR));
        label_2->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Arrow head width", Q_NULLPTR));
        label_6->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Start marker", Q_NULLPTR));
        mArrowHeadWidthSpinBox->setPrefix(QString());
        mArrowHeadWidthSpinBox->setSuffix(QApplication::translate("QgsLayoutPolylineWidgetBase", " mm", Q_NULLPTR));
        mArrowHeadStrokeColorButton->setText(QString());
        mEndMarkerToolButton->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "\342\200\246", Q_NULLPTR));
        mRadioStartNoMarker->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "None", Q_NULLPTR));
        mRadioStartArrow->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Arrow", Q_NULLPTR));
        mRadioStartSVG->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "SVG", Q_NULLPTR));
        label->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Arrow stroke width", Q_NULLPTR));
        mArrowHeadFillColorButton->setText(QString());
        label_7->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "End marker", Q_NULLPTR));
        mStartMarkerToolButton->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "\342\200\246", Q_NULLPTR));
        mRadioEndNoMarker->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "None", Q_NULLPTR));
        mRadioEndArrow->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Arrow", Q_NULLPTR));
        mRadioEndSvg->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "SVG", Q_NULLPTR));
        label_4->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "Arrow fill color", Q_NULLPTR));
        mStartMarkerLabel->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "SVG path", Q_NULLPTR));
        mStartMarkerLabel_2->setText(QApplication::translate("QgsLayoutPolylineWidgetBase", "SVG path", Q_NULLPTR));
