...
public:
    ...
    void setupUi(QWidget *WidgetMarkerLine)
    {
        if (WidgetMarkerLine->objectName().isEmpty())
            WidgetMarkerLine->setObjectName(QStringLiteral("WidgetMarkerLine"));
        WidgetMarkerLine->resize(371, 348);
        WidgetMarkerLine->setWindowTitle(QStringLiteral("Form"));
    ...
    {
        label_2->setText(QApplication::translate("WidgetMarkerLine", "Marker placement", Q_NULLPTR));
        radVertexLast->setText(QApplication::translate("WidgetMarkerLine", "on last vertex only", Q_NULLPTR));
        radCurvePoint->setText(QApplication::translate("WidgetMarkerLine", "on every curve point", Q_NULLPTR));
        mIntervalDDBtn->setText(QApplication::translate("WidgetMarkerLine", "\342\200\246", Q_NULLPTR));
        radVertexFirst->setText(QApplication::translate("WidgetMarkerLine", "on first vertex only", Q_NULLPTR));
        radVertex->setText(QApplication::translate("WidgetMarkerLine", "on every vertex", Q_NULLPTR));
        radInterval->setText(QApplication::translate("WidgetMarkerLine", "with interval", Q_NULLPTR));
        radCentralPoint->setText(QApplication::translate("WidgetMarkerLine", "on central point", Q_NULLPTR));
        radSegmentCentralPoint->setText(QApplication::translate("WidgetMarkerLine", "on central point of segments", Q_NULLPTR));
        mPlacementDDBtn->setText(QApplication::translate("WidgetMarkerLine", "\342\200\246", Q_NULLPTR));
        mLineOffsetDDBtn->setText(QApplication::translate("WidgetMarkerLine", "\342\200\246", Q_NULLPTR));
        label_4->setText(QApplication::translate("WidgetMarkerLine", "Average angle over", Q_NULLPTR));
        mAverageAngleDDBtn->setText(QApplication::translate("WidgetMarkerLine", "\342\200\246", Q_NULLPTR));
        mOffsetAlongLineDDBtn->setText(QApplication::translate("WidgetMarkerLine", "\342\200\246", Q_NULLPTR));
        label->setText(QApplication::translate("WidgetMarkerLine", "Offset along line", Q_NULLPTR));
        chkRotateMarker->setText(QApplication::translate("WidgetMarkerLine", "Rotate marker to follow line direction", Q_NULLPTR));
        label_3->setText(QApplication::translate("WidgetMarkerLine", "Line offset", Q_NULLPTR));
        mRingsLabel->setText(QApplication::translate("WidgetMarkerLine", "Rings", Q_NULLPTR));
