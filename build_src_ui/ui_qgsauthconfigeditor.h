...
public:
    ...
    void retranslateUi(QWidget *QgsAuthConfigEditor)
    {
        ...
        btnAddConfig->setToolTip(QApplication::translate("QgsAuthConfigEditor", "Add new authentication configuration", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        btnAddConfig->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnRemoveConfig->setToolTip(QApplication::translate("QgsAuthConfigEditor", "Remove selected authentication configuration", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        btnRemoveConfig->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnEditConfig->setToolTip(QApplication::translate("QgsAuthConfigEditor", "Edit selected authentication configuration", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
